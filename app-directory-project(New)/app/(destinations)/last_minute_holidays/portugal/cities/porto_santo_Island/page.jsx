...
import Porto_santo_island_HotelProperties from "@/components/hotel-list/last_minute_holidays/portugal/porto_santo_island/page";
          ...
          <div className="row">
            <div className="col-12">
              <div className="text-center">
                <h1 className="text-30 fw-600">Find Your Dream Luxury Hotel in Porto Santol Island</h1>
              </div>
              {/* End text-center */}
              {/* <MainFilterSearchBox /> */}
            </div>
        ...
        <div className="container">
          <div className="row y-gap-30">
            ...
            <div className="col-xl-9 ">
              ...
              {/* End mt--30 */}
              <div className="row y-gap-30">
                <Porto_santo_island_HotelProperties />
              </div>
              {/* End .row */}
              {/* <Pagination /> */}
            </div>
