...
import Kuta_HotelProperties from "@/components/hotel-list/last_minute_holidays/bali/kuta/page";
          ...
          <div className="row">
            <div className="col-12">
              <div className="text-center">
                <h1 className="text-30 fw-600">Find Your Dream Luxury Hotel In Kuta</h1>
              </div>
              {/* End text-center */}
              {/* <MainFilterSearchBox /> */}
            </div>
