...
import Overview from "@/components/city-hotels/last_minute_holidays/greece/zante/filoxenia_hotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/last_minute_holidays/greece/zante/filoxenia_hotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/last_minute_holidays/greece/zante/filoxenia_hotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/last_minute_holidays/greece/zante/filoxenia_hotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/last_minute_holidays/greece/zante/filoxenia_hotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/last_minute_holidays/greece/zante/filoxenia_hotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/last_minute_holidays/greece/zante/filoxenia_hotel/GalleryCruiseSlider";
...
const filoxenia_hotel = () => {
  const title = "Filoxenia Hotel";
...
export default dynamic(() => Promise.resolve(filoxenia_hotel), {
  ssr: false,
});
