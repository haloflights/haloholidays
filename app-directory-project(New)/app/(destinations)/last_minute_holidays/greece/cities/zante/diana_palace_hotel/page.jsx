...
import Overview from "@/components/city-hotels/last_minute_holidays/greece/zante/diana_palace_hotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/last_minute_holidays/greece/zante/diana_palace_hotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/last_minute_holidays/greece/zante/diana_palace_hotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/last_minute_holidays/greece/zante/diana_palace_hotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/last_minute_holidays/greece/zante/diana_palace_hotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/last_minute_holidays/greece/zante/diana_palace_hotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/last_minute_holidays/greece/zante/diana_palace_hotel/GalleryCruiseSlider";
...
const diana_palace_hotel = () => {
  const title = "Diana Palace Hotel";
...
export default dynamic(() => Promise.resolve(diana_palace_hotel), {
  ssr: false,
});
