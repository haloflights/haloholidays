...
import Overview from "@/components/city-hotels/last_minute_holidays/greece/zante/lesante_classic_luxury_hotel_and_spa/Overview";
import TopBreadCrumb from "@/components/city-hotels/last_minute_holidays/greece/zante/lesante_classic_luxury_hotel_and_spa/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/last_minute_holidays/greece/zante/lesante_classic_luxury_hotel_and_spa/SidebarRight";
import ReviewProgress from "@/components/city-hotels/last_minute_holidays/greece/zante/lesante_classic_luxury_hotel_and_spa/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/last_minute_holidays/greece/zante/lesante_classic_luxury_hotel_and_spa/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/last_minute_holidays/greece/zante/lesante_classic_luxury_hotel_and_spa/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/last_minute_holidays/greece/zante/lesante_classic_luxury_hotel_and_spa/GalleryCruiseSlider";
...
const lesante_classic_luxury_hotel_and_spa = () => {
  const title = "Lesante Classic Luxury Hotel and Spa";
...
export default dynamic(() => Promise.resolve(lesante_classic_luxury_hotel_and_spa), {
  ssr: false,
});
