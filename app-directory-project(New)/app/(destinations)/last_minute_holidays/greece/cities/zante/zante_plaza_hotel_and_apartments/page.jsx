...
import Overview from "@/components/city-hotels/last_minute_holidays/greece/zante/zante_plaza_hotel_and_apartments/Overview";
import TopBreadCrumb from "@/components/city-hotels/last_minute_holidays/greece/zante/zante_plaza_hotel_and_apartments/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/last_minute_holidays/greece/zante/zante_plaza_hotel_and_apartments/SidebarRight";
import ReviewProgress from "@/components/city-hotels/last_minute_holidays/greece/zante/zante_plaza_hotel_and_apartments/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/last_minute_holidays/greece/zante/zante_plaza_hotel_and_apartments/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/last_minute_holidays/greece/zante/zante_plaza_hotel_and_apartments/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/last_minute_holidays/greece/zante/zante_plaza_hotel_and_apartments/GalleryCruiseSlider";
...
const zante_plaza_hotel_and_apartments = () => {
  const title = "Zante Plaza Hotel & Apartments";
...
export default dynamic(() => Promise.resolve(zante_plaza_hotel_and_apartments), {
  ssr: false,
});
