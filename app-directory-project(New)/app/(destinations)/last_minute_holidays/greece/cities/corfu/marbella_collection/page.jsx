...
import Overview from "@/components/city-hotels/last_minute_holidays/greece/corfu/marbella_collection/Overview";
import TopBreadCrumb from "@/components/city-hotels/last_minute_holidays/greece/corfu/marbella_collection/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/last_minute_holidays/greece/corfu/marbella_collection/SidebarRight";
import ReviewProgress from "@/components/city-hotels/last_minute_holidays/greece/corfu/marbella_collection/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/last_minute_holidays/greece/corfu/marbella_collection/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/last_minute_holidays/greece/corfu/marbella_collection/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/last_minute_holidays/greece/corfu/marbella_collection/GalleryCruiseSlider";
...
const marbella_collection = () => {
  const title = "MarBella, Mar-Bella Collection";
...
export default dynamic(() => Promise.resolve(marbella_collection), {
  ssr: false,
});
