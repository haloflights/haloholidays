...
import Overview from "@/components/city-hotels/last_minute_holidays/phuket/kamala_beach/swissotel_resort_phuket/Overview";
import TopBreadCrumb from "@/components/city-hotels/last_minute_holidays/phuket/kamala_beach/swissotel_resort_phuket/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/last_minute_holidays/phuket/kamala_beach/swissotel_resort_phuket/SidebarRight";
import ReviewProgress from "@/components/city-hotels/last_minute_holidays/phuket/kamala_beach/swissotel_resort_phuket/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/last_minute_holidays/phuket/kamala_beach/swissotel_resort_phuket/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/last_minute_holidays/phuket/kamala_beach/swissotel_resort_phuket/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/last_minute_holidays/phuket/kamala_beach/swissotel_resort_phuket/GalleryCruiseSlider";
...
const swissotel_resort_phuket = () => {
  const title = "Swissotel Resort Phuket";
...
export default dynamic(() => Promise.resolve(swissotel_resort_phuket), {
  ssr: false,
});
