...
import SpainHero from "@/components/hero/family-hero/spain-hero";
import FilterHotels4 from "@/components/hotels/FilterHotels4";
import Cities from "@/components/holidays/family_holidays/cities/Cities";
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Top Destinations for Family Holidays</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
