...
import Sharm_el_sheikh_HotelProperties from "@/components/hotel-list/family_holidays/egypt/sharm_el_sheikh/page";
          ...
          <div className="row">
            <div className="col-12">
              <div className="text-center">
                <h1 className="text-30 fw-600">Find Your Dream Luxury HotelIn Sharm El Sheikh</h1>
              </div>
              {/* End text-center */}
              {/* <MainFilterSearchBox /> */}
            </div>
