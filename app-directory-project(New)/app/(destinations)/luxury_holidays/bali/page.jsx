...
import BaliHero from "@/components/hero/luxury-hero/bali-hero";
import Bali_cities from "@/components/holidays/luxury_holidays/cities/bali_cities";
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Top Destinations for Luxury Holidays</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
