...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/apartamentos_livvo_morromar/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/apartamentos_livvo_morromar/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/apartamentos_livvo_morromar/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/apartamentos_livvo_morromar/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/apartamentos_livvo_morromar/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/apartamentos_livvo_morromar/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/apartamentos_livvo_morromar/GalleryCruiseSlider";
...
const apartamentos_livvo_morromar = () => {
  const title = "Apartamentos LIVVO Morromar";
...
export default dynamic(() => Promise.resolve(apartamentos_livvo_morromar), {
  ssr: false,
});
