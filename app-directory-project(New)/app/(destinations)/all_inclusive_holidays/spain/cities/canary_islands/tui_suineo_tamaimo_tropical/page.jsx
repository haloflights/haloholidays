...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/tui_suineo_tamaimo_tropical/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/tui_suineo_tamaimo_tropical/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/tui_suineo_tamaimo_tropical/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/tui_suineo_tamaimo_tropical/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/tui_suineo_tamaimo_tropical/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/tui_suineo_tamaimo_tropical/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/tui_suineo_tamaimo_tropical/GalleryCruiseSlider";
...
const tui_suineo_tamaimo_tropical = () => {
  const title = "TUI SUNEO Tamaimo Tropical";
...
export default dynamic(() => Promise.resolve(tui_suineo_tamaimo_tropical), {
  ssr: false,
});
