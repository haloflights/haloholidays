...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/catalonia_punta_del_rey/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/catalonia_punta_del_rey/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/catalonia_punta_del_rey/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/catalonia_punta_del_rey/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/catalonia_punta_del_rey/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/catalonia_punta_del_rey/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/catalonia_punta_del_rey/GalleryCruiseSlider";
...
const catalonia_punta_del_rey = () => {
  const title = "Catalonia Punta del Rey";
...
export default dynamic(() => Promise.resolve(catalonia_punta_del_rey), {
  ssr: false,
});
