...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/sandos_papagayo/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/sandos_papagayo/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/sandos_papagayo/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/sandos_papagayo/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/sandos_papagayo/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/sandos_papagayo/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/sandos_papagayo/GalleryCruiseSlider";
...
const sandos_papagayo = () => {
  const title = "Sandos Papagayo";
...
export default dynamic(() => Promise.resolve(sandos_papagayo), {
  ssr: false,
});
