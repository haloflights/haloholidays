...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/paradise_island/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/paradise_island/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/paradise_island/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/paradise_island/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/paradise_island/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/paradise_island/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/canary_islands/paradise_island/GalleryCruiseSlider";
...
const paradise_island = () => {
  const title = "Paradise Island";
...
export default dynamic(() => Promise.resolve(paradise_island), {
  ssr: false,
});
