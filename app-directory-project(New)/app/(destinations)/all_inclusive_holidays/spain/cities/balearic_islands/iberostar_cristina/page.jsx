...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/iberostar_cristina/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/iberostar_cristina/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/iberostar_cristina/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/iberostar_cristina/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/iberostar_cristina/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/iberostar_cristina/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/iberostar_cristina/GalleryCruiseSlider";
...
const iberostar_cristina = () => {
  const title = "Iberostar Cristina";
...
export default dynamic(() => Promise.resolve(iberostar_cristina), {
  ssr: false,
});
