...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/insotel_carla_mandia_resort_and_spa/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/insotel_carla_mandia_resort_and_spa/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/insotel_carla_mandia_resort_and_spa/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/insotel_carla_mandia_resort_and_spa/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/insotel_carla_mandia_resort_and_spa/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/insotel_carla_mandia_resort_and_spa/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/insotel_carla_mandia_resort_and_spa/GalleryCruiseSlider";
...
const insotel_carla_mandia_resort_and_spa = () => {
  const title = "Insotel Cala Mandia Resort & Spa";
...
export default dynamic(() => Promise.resolve(insotel_carla_mandia_resort_and_spa), {
  ssr: false,
});
