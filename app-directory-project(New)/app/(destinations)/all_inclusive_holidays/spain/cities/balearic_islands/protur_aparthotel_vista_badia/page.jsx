...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/protur_aparthotel_vista_badia/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/protur_aparthotel_vista_badia/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/protur_aparthotel_vista_badia/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/protur_aparthotel_vista_badia/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/protur_aparthotel_vista_badia/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/protur_aparthotel_vista_badia/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/protur_aparthotel_vista_badia/GalleryCruiseSlider";
...
const protur_aparthotel_vista_badia = () => {
  const title = "Protur Aparthotel Vista Badia";
...
export default dynamic(() => Promise.resolve(protur_aparthotel_vista_badia), {
  ssr: false,
});
