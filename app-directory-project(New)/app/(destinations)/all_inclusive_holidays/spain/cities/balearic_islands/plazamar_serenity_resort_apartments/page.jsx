...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/plazamar_serenity_resort_apartments/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/plazamar_serenity_resort_apartments/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/plazamar_serenity_resort_apartments/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/plazamar_serenity_resort_apartments/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/plazamar_serenity_resort_apartments/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/plazamar_serenity_resort_apartments/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/plazamar_serenity_resort_apartments/GalleryCruiseSlider";
...
const plazamar_serenity_resort_apartments = () => {
  const title = "Plazamar Serenity Resort Apartments";
...
export default dynamic(() => Promise.resolve(plazamar_serenity_resort_apartments), {
  ssr: false,
});
