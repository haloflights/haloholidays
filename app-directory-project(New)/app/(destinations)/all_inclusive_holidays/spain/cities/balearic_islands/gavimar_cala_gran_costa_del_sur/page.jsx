...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/gavimar_cala_gran_costa_del_sur/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/gavimar_cala_gran_costa_del_sur/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/gavimar_cala_gran_costa_del_sur/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/gavimar_cala_gran_costa_del_sur/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/gavimar_cala_gran_costa_del_sur/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/gavimar_cala_gran_costa_del_sur/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/balearic_islands/gavimar_cala_gran_costa_del_sur/GalleryCruiseSlider";
...
const gavimar_cala_gran_costa_del_sur = () => {
  const title = "Gavimar Cala Gran Costa Del Sur";
...
export default dynamic(() => Promise.resolve(gavimar_cala_gran_costa_del_sur), {
  ssr: false,
});
