...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/hotel_mayorazgo/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/hotel_mayorazgo/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/hotel_mayorazgo/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/hotel_mayorazgo/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/hotel_mayorazgo/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/hotel_mayorazgo/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/hotel_mayorazgo/GalleryCruiseSlider";
...
const hotel_mayorazgo = () => {
  const title = "Hotel Mayorazgo";
...
export default dynamic(() => Promise.resolve(hotel_mayorazgo), {
  ssr: false,
});
