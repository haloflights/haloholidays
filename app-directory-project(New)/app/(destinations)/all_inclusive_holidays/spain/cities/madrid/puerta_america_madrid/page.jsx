...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/puerta_america_madrid/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/puerta_america_madrid/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/puerta_america_madrid/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/puerta_america_madrid/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/puerta_america_madrid/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/puerta_america_madrid/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/puerta_america_madrid/GalleryCruiseSlider";
...
const puerta_america_madrid = () => {
  const title = "Puerta America Madrid";
...
export default dynamic(() => Promise.resolve(puerta_america_madrid), {
  ssr: false,
});
