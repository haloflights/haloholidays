...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/room_mate_oscar/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/room_mate_oscar/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/room_mate_oscar/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/room_mate_oscar/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/room_mate_oscar/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/room_mate_oscar/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/room_mate_oscar/GalleryCruiseSlider";
...
const room_mate_oscar = () => {
  const title = "Room Mate Oscar";
...
export default dynamic(() => Promise.resolve(room_mate_oscar), {
  ssr: false,
});
