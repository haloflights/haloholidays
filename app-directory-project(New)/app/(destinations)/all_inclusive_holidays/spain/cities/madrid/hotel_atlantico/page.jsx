...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/hotel_atlantico/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/hotel_atlantico/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/hotel_atlantico/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/hotel_atlantico/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/hotel_atlantico/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/hotel_atlantico/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/madrid/hotel_atlantico/GalleryCruiseSlider";
...
const hotel_atlantico = () => {
  const title = "Hotel Atlantico";
...
export default dynamic(() => Promise.resolve(hotel_atlantico), {
  ssr: false,
});
