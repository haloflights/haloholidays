...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/barcelona/ramblas_barcelona/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/barcelona/ramblas_barcelona/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/barcelona/ramblas_barcelona/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/barcelona/ramblas_barcelona/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/barcelona/ramblas_barcelona/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/barcelona/ramblas_barcelona/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/barcelona/ramblas_barcelona/GalleryCruiseSlider";
...
const ramblas_barcelona = () => {
  const title = "Ramblas Barcelona";
...
export default dynamic(() => Promise.resolve(ramblas_barcelona), {
  ssr: false,
});
