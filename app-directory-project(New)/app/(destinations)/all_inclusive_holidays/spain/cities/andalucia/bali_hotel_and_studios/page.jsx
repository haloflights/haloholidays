...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/bali_hotel_and_studios/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/bali_hotel_and_studios/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/bali_hotel_and_studios/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/bali_hotel_and_studios/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/bali_hotel_and_studios/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/bali_hotel_and_studios/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/bali_hotel_and_studios/GalleryCruiseSlider";
...
const bali_hotel_and_studios = () => {
  const title = "Bali Hotel & Studios";
...
export default dynamic(() => Promise.resolve(bali_hotel_and_studios), {
  ssr: false,
});
