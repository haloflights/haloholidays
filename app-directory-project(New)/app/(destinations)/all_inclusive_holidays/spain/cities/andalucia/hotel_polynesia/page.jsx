...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/hotel_polynesia/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/hotel_polynesia/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/hotel_polynesia/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/hotel_polynesia/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/hotel_polynesia/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/hotel_polynesia/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/hotel_polynesia/GalleryCruiseSlider";
...
const hotel_polynesia = () => {
  const title = "Hotel Polynesia";
...
export default dynamic(() => Promise.resolve(hotel_polynesia), {
  ssr: false,
});
