...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/holiday_world_village_hotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/holiday_world_village_hotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/holiday_world_village_hotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/holiday_world_village_hotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/holiday_world_village_hotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/holiday_world_village_hotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/holiday_world_village_hotel/GalleryCruiseSlider";
...
const holiday_world_village_hotel = () => {
  const title = "Holiday World Village Hotel";
...
export default dynamic(() => Promise.resolve(holiday_world_village_hotel), {
  ssr: false,
});
