...
import Overview from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/riu_costa_del_sol/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/riu_costa_del_sol/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/riu_costa_del_sol/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/riu_costa_del_sol/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/riu_costa_del_sol/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/riu_costa_del_sol/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/spain/andalucia/riu_costa_del_sol/GalleryCruiseSlider";
...
const riu_costa_del_sol = () => {
  const title = "Riu Costa del Sol";
...
export default dynamic(() => Promise.resolve(riu_costa_del_sol), {
  ssr: false,
});
