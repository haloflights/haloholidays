...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/la_blanche_island/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/la_blanche_island/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/la_blanche_island/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/la_blanche_island/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/la_blanche_island/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/la_blanche_island/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/la_blanche_island/GalleryCruiseSlider";
...
const la_blanche_island = () => {
  const title = "La Blanche Island";
...
export default dynamic(() => Promise.resolve(la_blanche_island), {
  ssr: false,
});
