...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/delta_hotels_by_marriott_bodrum/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/delta_hotels_by_marriott_bodrum/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/delta_hotels_by_marriott_bodrum/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/delta_hotels_by_marriott_bodrum/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/delta_hotels_by_marriott_bodrum/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/delta_hotels_by_marriott_bodrum/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/delta_hotels_by_marriott_bodrum/GalleryCruiseSlider";
...
const delta_hotels_by_marriott_bodrum = () => {
  const title = "Delta Hotels by Marriott Bodrum";
...
export default dynamic(() => Promise.resolve(delta_hotels_by_marriott_bodrum), {
  ssr: false,
});
