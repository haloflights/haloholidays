...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/labranda_tmt_bodrum_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/labranda_tmt_bodrum_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/labranda_tmt_bodrum_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/labranda_tmt_bodrum_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/labranda_tmt_bodrum_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/labranda_tmt_bodrum_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/labranda_tmt_bodrum_resort/GalleryCruiseSlider";
...
const labranda_tmt_bodrum_resort = () => {
  const title = "Labranda TMT Bodrum Resort";
...
export default dynamic(() => Promise.resolve(labranda_tmt_bodrum_resort), {
  ssr: false,
});
