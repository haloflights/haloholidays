...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/arin_resort_bodrum/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/arin_resort_bodrum/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/arin_resort_bodrum/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/arin_resort_bodrum/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/arin_resort_bodrum/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/arin_resort_bodrum/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/arin_resort_bodrum/GalleryCruiseSlider";
...
const arin_resort_bodrum = () => {
  const title = "Arin Resort Bodrum";
...
export default dynamic(() => Promise.resolve(arin_resort_bodrum), {
  ssr: false,
});
