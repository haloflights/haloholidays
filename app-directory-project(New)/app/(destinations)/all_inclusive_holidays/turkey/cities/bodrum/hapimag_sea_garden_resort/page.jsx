...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/hapimag_sea_garden_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/hapimag_sea_garden_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/hapimag_sea_garden_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/hapimag_sea_garden_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/hapimag_sea_garden_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/hapimag_sea_garden_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/bodrum/hapimag_sea_garden_resort/GalleryCruiseSlider";
...
const hapimag_sea_garden_resort = () => {
  const title = "Hapimag Sea Garden Resort";
...
export default dynamic(() => Promise.resolve(hapimag_sea_garden_resort), {
  ssr: false,
});
