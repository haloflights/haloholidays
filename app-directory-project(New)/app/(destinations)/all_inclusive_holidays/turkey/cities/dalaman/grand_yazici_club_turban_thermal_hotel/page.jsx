...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_yazici_club_turban_thermal_hotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_yazici_club_turban_thermal_hotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_yazici_club_turban_thermal_hotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_yazici_club_turban_thermal_hotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_yazici_club_turban_thermal_hotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_yazici_club_turban_thermal_hotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_yazici_club_turban_thermal_hotel/GalleryCruiseSlider";
...
const grand_yazici_club_turban_thermal_hotel = () => {
  const title = "Grand Yazici Club Turban Thermal Hotel";
...
export default dynamic(() => Promise.resolve(grand_yazici_club_turban_thermal_hotel), {
  ssr: false,
});
