...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_aquarium/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_aquarium/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_aquarium/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_aquarium/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_aquarium/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_aquarium/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_aquarium/GalleryCruiseSlider";
...
const grand_aquarium = () => {
  const title = "Grand Aquarium";
...
export default dynamic(() => Promise.resolve(grand_aquarium), {
  ssr: false,
});
