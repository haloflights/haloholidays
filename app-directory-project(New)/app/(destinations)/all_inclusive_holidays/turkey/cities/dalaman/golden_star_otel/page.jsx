...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/golden_star_otel/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/golden_star_otel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/golden_star_otel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/golden_star_otel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/golden_star_otel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/golden_star_otel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/golden_star_otel/GalleryCruiseSlider";
...
const golden_star_otel = () => {
  const title = "Golden Star Otel";
...
export default dynamic(() => Promise.resolve(golden_star_otel), {
  ssr: false,
});
