...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_yazici_club_marmaris_palace/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_yazici_club_marmaris_palace/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_yazici_club_marmaris_palace/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_yazici_club_marmaris_palace/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_yazici_club_marmaris_palace/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_yazici_club_marmaris_palace/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/dalaman/grand_yazici_club_marmaris_palace/GalleryCruiseSlider";
...
const grand_yazici_club_marmaris_palace = () => {
  const title = "Grand Yazici Club Marmaris Palace";
...
export default dynamic(() => Promise.resolve(grand_yazici_club_marmaris_palace), {
  ssr: false,
});
