...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/titanic_deluxe_lara/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/titanic_deluxe_lara/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/titanic_deluxe_lara/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/titanic_deluxe_lara/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/titanic_deluxe_lara/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/titanic_deluxe_lara/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/titanic_deluxe_lara/GalleryCruiseSlider";
...
const titanic_deluxe_lara = () => {
  const title = "Titanic Deluxe Lara";
...
export default dynamic(() => Promise.resolve(titanic_deluxe_lara), {
  ssr: false,
});
