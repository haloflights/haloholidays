...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/liberty_hotels_lara/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/liberty_hotels_lara/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/liberty_hotels_lara/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/liberty_hotels_lara/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/liberty_hotels_lara/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/liberty_hotels_lara/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/liberty_hotels_lara/GalleryCruiseSlider";
...
const liberty_hotels_lara = () => {
  const title = "Liberty Hotels Lara";
...
export default dynamic(() => Promise.resolve(liberty_hotels_lara), {
  ssr: false,
});
