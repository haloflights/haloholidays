...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/tui_magic_life_masmavi/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/tui_magic_life_masmavi/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/tui_magic_life_masmavi/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/tui_magic_life_masmavi/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/tui_magic_life_masmavi/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/tui_magic_life_masmavi/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/antalya/tui_magic_life_masmavi/GalleryCruiseSlider";
...
const tui_magic_life_masmavi = () => {
  const title = "TUI Magic Life Masmavi";
...
export default dynamic(() => Promise.resolve(tui_magic_life_masmavi), {
  ssr: false,
});
