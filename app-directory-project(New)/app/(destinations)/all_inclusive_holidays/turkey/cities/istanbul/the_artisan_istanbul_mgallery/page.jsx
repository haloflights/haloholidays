...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/the_artisan_istanbul_mgallery/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/the_artisan_istanbul_mgallery/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/the_artisan_istanbul_mgallery/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/the_artisan_istanbul_mgallery/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/the_artisan_istanbul_mgallery/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/the_artisan_istanbul_mgallery/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/the_artisan_istanbul_mgallery/GalleryCruiseSlider";
...
const the_artisan_istanbul_mgallery = () => {
  const title = "The Artisan Istanbul Mgallery";
...
export default dynamic(() => Promise.resolve(the_artisan_istanbul_mgallery), {
  ssr: false,
});
