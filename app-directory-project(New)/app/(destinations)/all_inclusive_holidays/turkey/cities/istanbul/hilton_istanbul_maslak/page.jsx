...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/hilton_istanbul_maslak/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/hilton_istanbul_maslak/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/hilton_istanbul_maslak/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/hilton_istanbul_maslak/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/hilton_istanbul_maslak/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/hilton_istanbul_maslak/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/hilton_istanbul_maslak/GalleryCruiseSlider";
...
const hilton_istanbul_maslak = () => {
  const title = "Hilton Istanbul Maslak";
...
export default dynamic(() => Promise.resolve(hilton_istanbul_maslak), {
  ssr: false,
});
