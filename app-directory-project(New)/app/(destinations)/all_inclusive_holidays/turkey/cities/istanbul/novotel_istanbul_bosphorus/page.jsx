...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/novotel_istanbul_bosphorus/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/novotel_istanbul_bosphorus/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/novotel_istanbul_bosphorus/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/novotel_istanbul_bosphorus/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/novotel_istanbul_bosphorus/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/novotel_istanbul_bosphorus/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/novotel_istanbul_bosphorus/GalleryCruiseSlider";
...
const novotel_istanbul_bosphorus = () => {
  const title = "Novotel Istanbul Bosphorus";
...
export default dynamic(() => Promise.resolve(novotel_istanbul_bosphorus), {
  ssr: false,
});
