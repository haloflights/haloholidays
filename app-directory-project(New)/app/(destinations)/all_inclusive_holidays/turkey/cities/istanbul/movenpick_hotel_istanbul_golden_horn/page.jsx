...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/movenpick_hotel_istanbul_golden_horn/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/movenpick_hotel_istanbul_golden_horn/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/movenpick_hotel_istanbul_golden_horn/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/movenpick_hotel_istanbul_golden_horn/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/movenpick_hotel_istanbul_golden_horn/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/movenpick_hotel_istanbul_golden_horn/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/movenpick_hotel_istanbul_golden_horn/GalleryCruiseSlider";
...
const movenpick_hotel_istanbul_golden_horn = () => {
  const title = "Movenpick Hotel Istanbul Golden Horn";
...
export default dynamic(() => Promise.resolve(movenpick_hotel_istanbul_golden_horn), {
  ssr: false,
});
