...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/doubletree_by_hilton_istanbul_piyalepasa/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/doubletree_by_hilton_istanbul_piyalepasa/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/doubletree_by_hilton_istanbul_piyalepasa/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/doubletree_by_hilton_istanbul_piyalepasa/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/doubletree_by_hilton_istanbul_piyalepasa/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/doubletree_by_hilton_istanbul_piyalepasa/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/istanbul/doubletree_by_hilton_istanbul_piyalepasa/GalleryCruiseSlider";
...
const doubletree_by_hilton_istanbul_piyalepasa = () => {
  const title = "Doubletree by Hilton Istanbul Piyalepasa";
...
export default dynamic(() => Promise.resolve(doubletree_by_hilton_istanbul_piyalepasa), {
  ssr: false,
});
