...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/le_bleu_and_hotel_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/le_bleu_and_hotel_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/le_bleu_and_hotel_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/le_bleu_and_hotel_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/le_bleu_and_hotel_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/le_bleu_and_hotel_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/le_bleu_and_hotel_resort/GalleryCruiseSlider";
...
const le_bleu_and_hotel_resort = () => {
  const title = "Le Bleu & Hotel Resort";
...
export default dynamic(() => Promise.resolve(le_bleu_and_hotel_resort), {
  ssr: false,
});
