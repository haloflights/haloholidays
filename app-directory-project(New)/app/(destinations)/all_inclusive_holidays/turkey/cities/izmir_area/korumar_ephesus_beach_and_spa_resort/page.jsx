...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/korumar_ephesus_beach_and_spa_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/korumar_ephesus_beach_and_spa_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/korumar_ephesus_beach_and_spa_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/korumar_ephesus_beach_and_spa_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/korumar_ephesus_beach_and_spa_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/korumar_ephesus_beach_and_spa_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/korumar_ephesus_beach_and_spa_resort/GalleryCruiseSlider";
...
const korumar_ephesus_beach_and_spa_resort = () => {
  const title = "KoruMar Ephesus Beach & Spa Resort";
...
export default dynamic(() => Promise.resolve(korumar_ephesus_beach_and_spa_resort), {
  ssr: false,
});
