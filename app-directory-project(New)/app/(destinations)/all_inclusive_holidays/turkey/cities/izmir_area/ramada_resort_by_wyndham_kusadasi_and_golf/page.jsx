...
import Overview from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/ramada_resort_by_wyndham_kusadasi_and_golf/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/ramada_resort_by_wyndham_kusadasi_and_golf/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/ramada_resort_by_wyndham_kusadasi_and_golf/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/ramada_resort_by_wyndham_kusadasi_and_golf/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/ramada_resort_by_wyndham_kusadasi_and_golf/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/ramada_resort_by_wyndham_kusadasi_and_golf/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/turkey/izmir_area/ramada_resort_by_wyndham_kusadasi_and_golf/GalleryCruiseSlider";
...
const ramada_resort_by_wyndham_kusadasi_and_golf = () => {
  const title = "Ramada Resort by Wyndham Kusadasi & Golf";
...
export default dynamic(() => Promise.resolve(ramada_resort_by_wyndham_kusadasi_and_golf), {
  ssr: false,
});
