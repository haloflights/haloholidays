...
import Overview from "@/components/city-hotels/all_inclusive_holidays/mauritius/le_morne/riu_palace_mauritius/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/mauritius/le_morne/riu_palace_mauritius/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/mauritius/le_morne/riu_palace_mauritius/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/mauritius/le_morne/riu_palace_mauritius/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/mauritius/le_morne/riu_palace_mauritius/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/mauritius/le_morne/riu_palace_mauritius/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/mauritius/le_morne/riu_palace_mauritius/GalleryCruiseSlider";
...
const riu_palace_mauritius = () => {
  const title = "Riu Palace Mauritius";
...
export default dynamic(() => Promise.resolve(riu_palace_mauritius), {
  ssr: false,
});
