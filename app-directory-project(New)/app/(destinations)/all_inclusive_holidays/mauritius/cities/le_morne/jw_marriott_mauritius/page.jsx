...
import Overview from "@/components/city-hotels/all_inclusive_holidays/mauritius/le_morne/jw_marriott_mauritius/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/mauritius/le_morne/jw_marriott_mauritius/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/mauritius/le_morne/jw_marriott_mauritius/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/mauritius/le_morne/jw_marriott_mauritius/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/mauritius/le_morne/jw_marriott_mauritius/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/mauritius/le_morne/jw_marriott_mauritius/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/mauritius/le_morne/jw_marriott_mauritius/GalleryCruiseSlider";
...
const jw_marriott_mauritius = () => {
  const title = "JW Marriott Mauritius";
...
export default dynamic(() => Promise.resolve(jw_marriott_mauritius), {
  ssr: false,
});
