...
import Overview from "@/components/city-hotels/all_inclusive_holidays/mauritius/flic_en_flac/sofitel_mauritius_l_imperial_resort_and_spa/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/mauritius/flic_en_flac/sofitel_mauritius_l_imperial_resort_and_spa/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/mauritius/flic_en_flac/sofitel_mauritius_l_imperial_resort_and_spa/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/mauritius/flic_en_flac/sofitel_mauritius_l_imperial_resort_and_spa/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/mauritius/flic_en_flac/sofitel_mauritius_l_imperial_resort_and_spa/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/mauritius/flic_en_flac/sofitel_mauritius_l_imperial_resort_and_spa/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/mauritius/flic_en_flac/sofitel_mauritius_l_imperial_resort_and_spa/GalleryCruiseSlider";
...
const sofitel_mauritius_l_imperial_resort_and_spa = () => {
  const title = "Sofitel Mauritius L'Impérial Resort & Spa";
...
export default dynamic(() => Promise.resolve(sofitel_mauritius_l_imperial_resort_and_spa), {
  ssr: false,
});
