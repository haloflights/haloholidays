...
import Overview from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/tropical_attitude/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/tropical_attitude/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/tropical_attitude/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/tropical_attitude/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/tropical_attitude/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/tropical_attitude/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/tropical_attitude/GalleryCruiseSlider";
...
const tropical_attitude = () => {
  const title = "Tropical Attitude";
...
export default dynamic(() => Promise.resolve(tropical_attitude), {
  ssr: false,
});
