...
import Overview from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/friday_attitude/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/friday_attitude/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/friday_attitude/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/friday_attitude/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/friday_attitude/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/friday_attitude/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/friday_attitude/GalleryCruiseSlider";
...
const friday_attitude = () => {
  const title = "Friday Attitude";
...
export default dynamic(() => Promise.resolve(friday_attitude), {
  ssr: false,
});
