...
import Overview from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/sunrise_attitude/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/sunrise_attitude/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/sunrise_attitude/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/sunrise_attitude/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/sunrise_attitude/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/sunrise_attitude/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/mauritius/trou_deau_douce/sunrise_attitude/GalleryCruiseSlider";
...
const sunrise_attitude = () => {
  const title = "Sunrise Attitude";
...
export default dynamic(() => Promise.resolve(sunrise_attitude), {
  ssr: false,
});
