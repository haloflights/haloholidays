...
import Overview from "@/components/city-hotels/all_inclusive_holidays/mauritius/grand_baie/seapoint_boutique_hotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/mauritius/grand_baie/seapoint_boutique_hotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/mauritius/grand_baie/seapoint_boutique_hotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/mauritius/grand_baie/seapoint_boutique_hotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/mauritius/grand_baie/seapoint_boutique_hotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/mauritius/grand_baie/seapoint_boutique_hotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/mauritius/grand_baie/seapoint_boutique_hotel/GalleryCruiseSlider";
...
const seapoint_boutique_hotel = () => {
  const title = "Seapoint Boutique Hotel";
...
export default dynamic(() => Promise.resolve(seapoint_boutique_hotel), {
  ssr: false,
});
