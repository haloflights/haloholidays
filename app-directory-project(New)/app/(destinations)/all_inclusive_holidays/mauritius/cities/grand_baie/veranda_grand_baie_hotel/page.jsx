...
import Overview from "@/components/city-hotels/all_inclusive_holidays/mauritius/grand_baie/veranda_grand_baie_hotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/mauritius/grand_baie/veranda_grand_baie_hotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/mauritius/grand_baie/veranda_grand_baie_hotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/mauritius/grand_baie/veranda_grand_baie_hotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/mauritius/grand_baie/veranda_grand_baie_hotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/mauritius/grand_baie/veranda_grand_baie_hotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/mauritius/grand_baie/veranda_grand_baie_hotel/GalleryCruiseSlider";
...
const veranda_grand_baie_hotel = () => {
  const title = "Veranda Grand Baie Hotel";
...
export default dynamic(() => Promise.resolve(veranda_grand_baie_hotel), {
  ssr: false,
});
