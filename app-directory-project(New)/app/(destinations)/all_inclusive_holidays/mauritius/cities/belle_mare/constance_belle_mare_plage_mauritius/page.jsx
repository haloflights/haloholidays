...
import Overview from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/constance_belle_mare_plage_mauritius/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/constance_belle_mare_plage_mauritius/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/constance_belle_mare_plage_mauritius/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/constance_belle_mare_plage_mauritius/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/constance_belle_mare_plage_mauritius/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/constance_belle_mare_plage_mauritius/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/constance_belle_mare_plage_mauritius/GalleryCruiseSlider";
...
const constance_belle_mare_plage_mauritius = () => {
  const title = "Constance Belle Mare Plage Mauritius";
...
export default dynamic(() => Promise.resolve(constance_belle_mare_plage_mauritius), {
  ssr: false,
});
