...
import Overview from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/lux_belle_mare/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/lux_belle_mare/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/lux_belle_mare/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/lux_belle_mare/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/lux_belle_mare/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/lux_belle_mare/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/lux_belle_mare/GalleryCruiseSlider";
...
const lux_belle_mare = () => {
  const title = "LUX* Belle Mare";
...
export default dynamic(() => Promise.resolve(lux_belle_mare), {
  ssr: false,
});
