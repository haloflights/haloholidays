...
import Overview from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/solana_beach_mauritius/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/solana_beach_mauritius/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/solana_beach_mauritius/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/solana_beach_mauritius/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/solana_beach_mauritius/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/solana_beach_mauritius/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/mauritius/belle_mare/solana_beach_mauritius/GalleryCruiseSlider";
...
const solana_beach_mauritius = () => {
  const title = "Solana Beach Mauritius";
...
export default dynamic(() => Promise.resolve(solana_beach_mauritius), {
  ssr: false,
});
