...
import Overview from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/olympic_lagoon_resort_ayia_napa/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/olympic_lagoon_resort_ayia_napa/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/olympic_lagoon_resort_ayia_napa/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/olympic_lagoon_resort_ayia_napa/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/olympic_lagoon_resort_ayia_napa/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/olympic_lagoon_resort_ayia_napa/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/olympic_lagoon_resort_ayia_napa/GalleryCruiseSlider";
...
const olympic_lagoon_resort_ayia_napa = () => {
  const title = "Olympic Lagoon Resort Ayia Napa";
...
export default dynamic(() => Promise.resolve(olympic_lagoon_resort_ayia_napa), {
  ssr: false,
});
