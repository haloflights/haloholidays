...
import Overview from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/hotel_pernera_beach/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/hotel_pernera_beach/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/hotel_pernera_beach/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/hotel_pernera_beach/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/hotel_pernera_beach/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/hotel_pernera_beach/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/hotel_pernera_beach/GalleryCruiseSlider";
...
const hotel_pernera_beach = () => {
  const title = "Hotel Pernera Beach";
...
export default dynamic(() => Promise.resolve(hotel_pernera_beach), {
  ssr: false,
});
