...
import Overview from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/vrissaki_beach_hotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/vrissaki_beach_hotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/vrissaki_beach_hotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/vrissaki_beach_hotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/vrissaki_beach_hotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/vrissaki_beach_hotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/vrissaki_beach_hotel/GalleryCruiseSlider";
...
const vrissaki_beach_hotel = () => {
  const title = "Vrissaki Beach Hotel";
...
export default dynamic(() => Promise.resolve(vrissaki_beach_hotel), {
  ssr: false,
});
