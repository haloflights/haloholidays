...
import Overview from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/sentido_sandy_beach_hotel_and_spa/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/sentido_sandy_beach_hotel_and_spa/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/sentido_sandy_beach_hotel_and_spa/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/sentido_sandy_beach_hotel_and_spa/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/sentido_sandy_beach_hotel_and_spa/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/sentido_sandy_beach_hotel_and_spa/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/cyprus/larnaca_area/sentido_sandy_beach_hotel_and_spa/GalleryCruiseSlider";
...
const sentido_sandy_beach_hotel_and_spa = () => {
  const title = "Sentido Sandy Beach Hotel & Spa";
...
export default dynamic(() => Promise.resolve(sentido_sandy_beach_hotel_and_spa), {
  ssr: false,
});
