...
import Overview from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/louis_phaethon_beach/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/louis_phaethon_beach/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/louis_phaethon_beach/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/louis_phaethon_beach/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/louis_phaethon_beach/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/louis_phaethon_beach/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/louis_phaethon_beach/GalleryCruiseSlider";
...
const louis_phaethon_beach = () => {
  const title = "Louis Phaethon Beach";
...
export default dynamic(() => Promise.resolve(louis_phaethon_beach), {
  ssr: false,
});
