...
import Overview from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/coral_beach_hotel_and_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/coral_beach_hotel_and_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/coral_beach_hotel_and_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/coral_beach_hotel_and_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/coral_beach_hotel_and_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/coral_beach_hotel_and_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/coral_beach_hotel_and_resort/GalleryCruiseSlider";
...
const coral_beach_hotel_and_resort = () => {
  const title = "Coral Beach Hotel & Resort";
...
export default dynamic(() => Promise.resolve(coral_beach_hotel_and_resort), {
  ssr: false,
});
