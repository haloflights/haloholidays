...
import Overview from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/atlantica_oasis_hotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/atlantica_oasis_hotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/atlantica_oasis_hotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/atlantica_oasis_hotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/atlantica_oasis_hotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/atlantica_oasis_hotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/cyprus/paphos_area/atlantica_oasis_hotel/GalleryCruiseSlider";
...
const atlantica_oasis_hotel = () => {
  const title = "Atlantica Oasis Hotel";
...
export default dynamic(() => Promise.resolve(atlantica_oasis_hotel), {
  ssr: false,
});
