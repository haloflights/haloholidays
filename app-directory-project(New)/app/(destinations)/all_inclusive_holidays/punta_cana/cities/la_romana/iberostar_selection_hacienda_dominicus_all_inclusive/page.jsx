...
import Overview from "@/components/city-hotels/punta_cana/la_romana/iberostar_selection_hacienda_dominicus_all_inclusive/Overview";
import TopBreadCrumb from "@/components/city-hotels/punta_cana/la_romana/iberostar_selection_hacienda_dominicus_all_inclusive/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/punta_cana/la_romana/iberostar_selection_hacienda_dominicus_all_inclusive/SidebarRight";
import ReviewProgress from "@/components/city-hotels/punta_cana/la_romana/iberostar_selection_hacienda_dominicus_all_inclusive/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/punta_cana/la_romana/iberostar_selection_hacienda_dominicus_all_inclusive/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/punta_cana/la_romana/iberostar_selection_hacienda_dominicus_all_inclusive/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/punta_cana/la_romana/iberostar_selection_hacienda_dominicus_all_inclusive/GalleryCruiseSlider";
...
const iberostar_selection_hacienda_dominicus_all_inclusive = () => {
  const title = "Iberostar Selection Hacienda Dominicus - All Inclusive";
...
export default dynamic(() => Promise.resolve(iberostar_selection_hacienda_dominicus_all_inclusive), {
  ssr: false,
});
