...
import Overview from "@/components/city-hotels/punta_cana/bavaro/riu_palace_bavaro/Overview";
import TopBreadCrumb from "@/components/city-hotels/punta_cana/bavaro/riu_palace_bavaro/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/punta_cana/bavaro/riu_palace_bavaro/SidebarRight";
import ReviewProgress from "@/components/city-hotels/punta_cana/bavaro/riu_palace_bavaro/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/punta_cana/bavaro/riu_palace_bavaro/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/punta_cana/bavaro/riu_palace_bavaro/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/punta_cana/bavaro/riu_palace_bavaro/GalleryCruiseSlider";
...
const riu_palace_bavaro = () => {
  const title = "Riu Palace Bavaro";
...
export default dynamic(() => Promise.resolve(riu_palace_bavaro), {
  ssr: false,
});
