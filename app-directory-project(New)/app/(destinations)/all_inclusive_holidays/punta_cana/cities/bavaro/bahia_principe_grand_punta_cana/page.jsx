...
import Overview from "@/components/city-hotels/punta_cana/bavaro/bahia_principe_grand_punta_cana/Overview";
import TopBreadCrumb from "@/components/city-hotels/punta_cana/bavaro/bahia_principe_grand_punta_cana/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/punta_cana/bavaro/bahia_principe_grand_punta_cana/SidebarRight";
import ReviewProgress from "@/components/city-hotels/punta_cana/bavaro/bahia_principe_grand_punta_cana/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/punta_cana/bavaro/bahia_principe_grand_punta_cana/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/punta_cana/bavaro/bahia_principe_grand_punta_cana/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/punta_cana/bavaro/bahia_principe_grand_punta_cana/GalleryCruiseSlider";
...
const bahia_principe_grand_punta_cana = () => {
  const title = "Bahia Principe Grand Punta Cana";
...
export default dynamic(() => Promise.resolve(bahia_principe_grand_punta_cana), {
  ssr: false,
});
