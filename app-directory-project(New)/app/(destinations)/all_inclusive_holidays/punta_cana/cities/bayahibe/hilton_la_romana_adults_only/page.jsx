...
import Overview from "@/components/city-hotels/punta_cana/bayahibe/hilton_la_romana_adults_only/Overview";
import TopBreadCrumb from "@/components/city-hotels/punta_cana/bayahibe/hilton_la_romana_adults_only/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/punta_cana/bayahibe/hilton_la_romana_adults_only/SidebarRight";
import ReviewProgress from "@/components/city-hotels/punta_cana/bayahibe/hilton_la_romana_adults_only/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/punta_cana/bayahibe/hilton_la_romana_adults_only/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/punta_cana/bayahibe/hilton_la_romana_adults_only/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/punta_cana/bayahibe/hilton_la_romana_adults_only/GalleryCruiseSlider";
...
const hilton_la_romana_adults_only = () => {
  const title = "Hilton La Romana Adults Only";
...
export default dynamic(() => Promise.resolve(hilton_la_romana_adults_only), {
  ssr: false,
});
