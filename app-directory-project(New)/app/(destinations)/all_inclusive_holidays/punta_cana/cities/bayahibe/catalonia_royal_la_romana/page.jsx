...
import Overview from "@/components/city-hotels/punta_cana/bayahibe/catalonia_royal_la_romana/Overview";
import TopBreadCrumb from "@/components/city-hotels/punta_cana/bayahibe/catalonia_royal_la_romana/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/punta_cana/bayahibe/catalonia_royal_la_romana/SidebarRight";
import ReviewProgress from "@/components/city-hotels/punta_cana/bayahibe/catalonia_royal_la_romana/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/punta_cana/bayahibe/catalonia_royal_la_romana/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/punta_cana/bayahibe/catalonia_royal_la_romana/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/punta_cana/bayahibe/catalonia_royal_la_romana/GalleryCruiseSlider";
...
const catalonia_royal_la_romana = () => {
  const title = "Catalonia Royal La Romana";
...
export default dynamic(() => Promise.resolve(catalonia_royal_la_romana), {
  ssr: false,
});
