...
import Overview from "@/components/city-hotels/punta_cana/bayahibe/hilton_la_romana_family_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/punta_cana/bayahibe/hilton_la_romana_family_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/punta_cana/bayahibe/hilton_la_romana_family_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/punta_cana/bayahibe/hilton_la_romana_family_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/punta_cana/bayahibe/hilton_la_romana_family_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/punta_cana/bayahibe/hilton_la_romana_family_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/punta_cana/bayahibe/hilton_la_romana_family_resort/GalleryCruiseSlider";
...
const hilton_la_romana_family_resort = () => {
  const title = "Hilton La Romana Family Resort";
...
export default dynamic(() => Promise.resolve(hilton_la_romana_family_resort), {
  ssr: false,
});
