...
import Overview from "@/components/city-hotels/punta_cana/uvero_alto/breathless_punta_cana_resort_and_spa/Overview";
import TopBreadCrumb from "@/components/city-hotels/punta_cana/uvero_alto/breathless_punta_cana_resort_and_spa/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/punta_cana/uvero_alto/breathless_punta_cana_resort_and_spa/SidebarRight";
import ReviewProgress from "@/components/city-hotels/punta_cana/uvero_alto/breathless_punta_cana_resort_and_spa/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/punta_cana/uvero_alto/breathless_punta_cana_resort_and_spa/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/punta_cana/uvero_alto/breathless_punta_cana_resort_and_spa/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/punta_cana/uvero_alto/breathless_punta_cana_resort_and_spa/GalleryCruiseSlider";
...
const breathless_punta_cana_resort_and_spa = () => {
  const title = "Breathless Punta Cana Resort & Spa";
...
export default dynamic(() => Promise.resolve(breathless_punta_cana_resort_and_spa), {
  ssr: false,
});
