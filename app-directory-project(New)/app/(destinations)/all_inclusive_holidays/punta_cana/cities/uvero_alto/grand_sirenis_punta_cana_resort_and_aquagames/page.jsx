...
import Overview from "@/components/city-hotels/punta_cana/uvero_alto/grand_sirenis_punta_cana_resort_and_aquagames/Overview";
import TopBreadCrumb from "@/components/city-hotels/punta_cana/uvero_alto/grand_sirenis_punta_cana_resort_and_aquagames/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/punta_cana/uvero_alto/grand_sirenis_punta_cana_resort_and_aquagames/SidebarRight";
import ReviewProgress from "@/components/city-hotels/punta_cana/uvero_alto/grand_sirenis_punta_cana_resort_and_aquagames/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/punta_cana/uvero_alto/grand_sirenis_punta_cana_resort_and_aquagames/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/punta_cana/uvero_alto/grand_sirenis_punta_cana_resort_and_aquagames/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/punta_cana/uvero_alto/grand_sirenis_punta_cana_resort_and_aquagames/GalleryCruiseSlider";
...
const grand_sirenis_punta_cana_resort_and_aquagames = () => {
  const title = "Grand Sirenis Punta Cana Resort & Aquagames";
...
export default dynamic(() => Promise.resolve(grand_sirenis_punta_cana_resort_and_aquagames), {
  ssr: false,
});
