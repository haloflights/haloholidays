...
import Overview from "@/components/city-hotels/punta_cana/uvero_alto/dreams_onyx_resort_and_spa/Overview";
import TopBreadCrumb from "@/components/city-hotels/punta_cana/uvero_alto/dreams_onyx_resort_and_spa/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/punta_cana/uvero_alto/dreams_onyx_resort_and_spa/SidebarRight";
import ReviewProgress from "@/components/city-hotels/punta_cana/uvero_alto/dreams_onyx_resort_and_spa/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/punta_cana/uvero_alto/dreams_onyx_resort_and_spa/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/punta_cana/uvero_alto/dreams_onyx_resort_and_spa/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/punta_cana/uvero_alto/dreams_onyx_resort_and_spa/GalleryCruiseSlider";
...
const dreams_onyx_resort_and_spa = () => {
  const title = "Dreams Onyx Resort & Spa";
...
export default dynamic(() => Promise.resolve(dreams_onyx_resort_and_spa), {
  ssr: false,
});
