...
import Overview from "@/components/city-hotels/punta_cana/cap_cana/dreams_royal_beach_punta_cana/Overview";
import TopBreadCrumb from "@/components/city-hotels/punta_cana/cap_cana/dreams_royal_beach_punta_cana/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/punta_cana/cap_cana/dreams_royal_beach_punta_cana/SidebarRight";
import ReviewProgress from "@/components/city-hotels/punta_cana/cap_cana/dreams_royal_beach_punta_cana/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/punta_cana/cap_cana/dreams_royal_beach_punta_cana/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/punta_cana/cap_cana/dreams_royal_beach_punta_cana/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/punta_cana/cap_cana/dreams_royal_beach_punta_cana/GalleryCruiseSlider";
...
const dreams_royal_beach_punta_cana = () => {
  const title = "Dreams Royal Beach Punta Cana";
...
export default dynamic(() => Promise.resolve(dreams_royal_beach_punta_cana), {
  ssr: false,
});
