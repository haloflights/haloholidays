...
import Overview from "@/components/city-hotels/punta_cana/cap_cana/margaritaville_island_reserve_cap_cana/Overview";
import TopBreadCrumb from "@/components/city-hotels/punta_cana/cap_cana/margaritaville_island_reserve_cap_cana/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/punta_cana/cap_cana/margaritaville_island_reserve_cap_cana/SidebarRight";
import ReviewProgress from "@/components/city-hotels/punta_cana/cap_cana/margaritaville_island_reserve_cap_cana/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/punta_cana/cap_cana/margaritaville_island_reserve_cap_cana/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/punta_cana/cap_cana/margaritaville_island_reserve_cap_cana/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/punta_cana/cap_cana/margaritaville_island_reserve_cap_cana/GalleryCruiseSlider";
...
const margaritaville_island_reserve_cap_cana = () => {
  const title = "Margaritaville Island Reserve Cap Cana";
...
export default dynamic(() => Promise.resolve(margaritaville_island_reserve_cap_cana), {
  ssr: false,
});
