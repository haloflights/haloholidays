...
import Overview from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/cape_sienna_phuket_hotel_and_villas/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/cape_sienna_phuket_hotel_and_villas/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/cape_sienna_phuket_hotel_and_villas/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/cape_sienna_phuket_hotel_and_villas/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/cape_sienna_phuket_hotel_and_villas/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/cape_sienna_phuket_hotel_and_villas/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/cape_sienna_phuket_hotel_and_villas/GalleryCruiseSlider";
...
const cape_sienna_phuket_hotel_and_villas = () => {
  const title = "Cape Sienna Phuket Hotel & Villas";
...
export default dynamic(() => Promise.resolve(cape_sienna_phuket_hotel_and_villas), {
  ssr: false,
});
