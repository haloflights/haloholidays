...
import Overview from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/novotel_phuket_kamala/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/novotel_phuket_kamala/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/novotel_phuket_kamala/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/novotel_phuket_kamala/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/novotel_phuket_kamala/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/novotel_phuket_kamala/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/novotel_phuket_kamala/GalleryCruiseSlider";
...
const novotel_phuket_kamala = () => {
  const title = "Novotel Phuket Kamala";
...
export default dynamic(() => Promise.resolve(novotel_phuket_kamala), {
  ssr: false,
});
