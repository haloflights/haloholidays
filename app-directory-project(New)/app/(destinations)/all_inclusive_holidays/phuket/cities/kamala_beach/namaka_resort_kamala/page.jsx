...
import Overview from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/namaka_resort_kamala/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/namaka_resort_kamala/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/namaka_resort_kamala/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/namaka_resort_kamala/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/namaka_resort_kamala/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/namaka_resort_kamala/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/phuket/kamala_beach/namaka_resort_kamala/GalleryCruiseSlider";
...
const namaka_resort_kamala = () => {
  const title = "Namaka Resort Kamala";
...
export default dynamic(() => Promise.resolve(namaka_resort_kamala), {
  ssr: false,
});
