...
import Overview from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/katathani_phuket_beach_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/katathani_phuket_beach_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/katathani_phuket_beach_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/katathani_phuket_beach_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/katathani_phuket_beach_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/katathani_phuket_beach_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/katathani_phuket_beach_resort/GalleryCruiseSlider";
...
const katathani_phuket_beach_resort = () => {
  const title = "Katathani Phuket Beach Resort";
...
export default dynamic(() => Promise.resolve(katathani_phuket_beach_resort), {
  ssr: false,
});
