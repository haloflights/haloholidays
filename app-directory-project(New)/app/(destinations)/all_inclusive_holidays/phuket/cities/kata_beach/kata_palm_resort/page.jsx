...
import Overview from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/kata_palm_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/kata_palm_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/kata_palm_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/kata_palm_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/kata_palm_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/kata_palm_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/kata_palm_resort/GalleryCruiseSlider";
...
const kata_palm_resort = () => {
  const title = "Kata Palm Resort";
...
export default dynamic(() => Promise.resolve(kata_palm_resort), {
  ssr: false,
});
