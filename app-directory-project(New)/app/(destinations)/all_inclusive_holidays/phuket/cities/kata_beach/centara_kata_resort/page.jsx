...
import Overview from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/centara_kata_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/centara_kata_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/centara_kata_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/centara_kata_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/centara_kata_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/centara_kata_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/centara_kata_resort/GalleryCruiseSlider";
...
const centara_kata_resort = () => {
  const title = "Centara Kata Resort, Phuket";
...
export default dynamic(() => Promise.resolve(centara_kata_resort), {
  ssr: false,
});
