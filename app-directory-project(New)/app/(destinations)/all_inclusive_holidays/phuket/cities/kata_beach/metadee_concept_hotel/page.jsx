...
import Overview from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/metadee_concept_hotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/metadee_concept_hotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/metadee_concept_hotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/metadee_concept_hotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/metadee_concept_hotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/metadee_concept_hotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/metadee_concept_hotel/GalleryCruiseSlider";
...
const metadee_concept_hotel = () => {
  const title = "Metadee Concept Hotel";
...
export default dynamic(() => Promise.resolve(metadee_concept_hotel), {
  ssr: false,
});
