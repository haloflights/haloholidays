...
import Overview from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/andaman_cannacia_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/andaman_cannacia_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/andaman_cannacia_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/andaman_cannacia_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/andaman_cannacia_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/andaman_cannacia_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/phuket/kata_beach/andaman_cannacia_resort/GalleryCruiseSlider";
...
const andaman_cannacia_resort = () => {
  const title = "Andaman Cannacia Resort";
...
export default dynamic(() => Promise.resolve(andaman_cannacia_resort), {
  ssr: false,
});
