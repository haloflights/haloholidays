...
import Overview from "@/components/city-hotels/all_inclusive_holidays/phuket/patong_beach/patong_merlin_hotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/phuket/patong_beach/patong_merlin_hotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/phuket/patong_beach/patong_merlin_hotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/phuket/patong_beach/patong_merlin_hotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/phuket/patong_beach/patong_merlin_hotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/phuket/patong_beach/patong_merlin_hotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/phuket/patong_beach/patong_merlin_hotel/GalleryCruiseSlider";
...
const patong_merlin_hotel = () => {
  const title = "Patong Merlin Hotel";
...
export default dynamic(() => Promise.resolve(patong_merlin_hotel), {
  ssr: false,
});
