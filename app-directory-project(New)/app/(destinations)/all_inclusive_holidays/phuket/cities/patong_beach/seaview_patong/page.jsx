...
import Overview from "@/components/city-hotels/all_inclusive_holidays/phuket/patong_beach/seaview_patong/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/phuket/patong_beach/seaview_patong/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/phuket/patong_beach/seaview_patong/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/phuket/patong_beach/seaview_patong/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/phuket/patong_beach/seaview_patong/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/phuket/patong_beach/seaview_patong/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/phuket/patong_beach/seaview_patong/GalleryCruiseSlider";
...
const seaview_patong = () => {
  const title = "Seaview Patong";
...
export default dynamic(() => Promise.resolve(seaview_patong), {
  ssr: false,
});
