...
import Overview from "@/components/city-hotels/all_inclusive_holidays/phuket/karon_beach/andaman_seaview/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/phuket/karon_beach/andaman_seaview/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/phuket/karon_beach/andaman_seaview/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/phuket/karon_beach/andaman_seaview/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/phuket/karon_beach/andaman_seaview/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/phuket/karon_beach/andaman_seaview/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/phuket/karon_beach/andaman_seaview/GalleryCruiseSlider";
...
const andaman_seaview = () => {
  const title = "Andaman Seaview";
...
export default dynamic(() => Promise.resolve(andaman_seaview), {
  ssr: false,
});
