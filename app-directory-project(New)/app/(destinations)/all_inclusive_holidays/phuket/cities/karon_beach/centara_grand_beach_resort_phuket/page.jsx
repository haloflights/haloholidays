...
import Overview from "@/components/city-hotels/all_inclusive_holidays/phuket/karon_beach/centara_grand_beach_resort_phuket/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/phuket/karon_beach/centara_grand_beach_resort_phuket/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/phuket/karon_beach/centara_grand_beach_resort_phuket/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/phuket/karon_beach/centara_grand_beach_resort_phuket/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/phuket/karon_beach/centara_grand_beach_resort_phuket/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/phuket/karon_beach/centara_grand_beach_resort_phuket/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/phuket/karon_beach/centara_grand_beach_resort_phuket/GalleryCruiseSlider";
...
const centara_grand_beach_resort_phuket = () => {
  const title = "Centara Grand Beach Resort Phuket";
...
export default dynamic(() => Promise.resolve(centara_grand_beach_resort_phuket), {
  ssr: false,
});
