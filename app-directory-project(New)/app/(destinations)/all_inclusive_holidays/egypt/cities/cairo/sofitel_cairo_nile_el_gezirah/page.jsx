...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/sofitel_cairo_nile_el_gezirah/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/sofitel_cairo_nile_el_gezirah/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/sofitel_cairo_nile_el_gezirah/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/sofitel_cairo_nile_el_gezirah/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/sofitel_cairo_nile_el_gezirah/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/sofitel_cairo_nile_el_gezirah/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/sofitel_cairo_nile_el_gezirah/GalleryCruiseSlider";
...
const sofitel_cairo_nile_el_gezirah = () => {
  const title = "Sofitel Cairo Nile El Gezirah";
...
export default dynamic(() => Promise.resolve(sofitel_cairo_nile_el_gezirah), {
  ssr: false,
});
