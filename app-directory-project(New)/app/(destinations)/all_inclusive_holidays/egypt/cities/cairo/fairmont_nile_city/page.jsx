...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/fairmont_nile_city/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/fairmont_nile_city/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/fairmont_nile_city/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/fairmont_nile_city/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/fairmont_nile_city/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/fairmont_nile_city/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/fairmont_nile_city/GalleryCruiseSlider";
...
const fairmont_nile_city = () => {
  const title = "Fairmont Nile City";
...
export default dynamic(() => Promise.resolve(fairmont_nile_city), {
  ssr: false,
});
