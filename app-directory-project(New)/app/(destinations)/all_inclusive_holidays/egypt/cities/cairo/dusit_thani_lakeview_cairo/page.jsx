...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/dusit_thani_lakeview_cairo/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/dusit_thani_lakeview_cairo/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/dusit_thani_lakeview_cairo/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/dusit_thani_lakeview_cairo/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/dusit_thani_lakeview_cairo/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/dusit_thani_lakeview_cairo/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/cairo/dusit_thani_lakeview_cairo/GalleryCruiseSlider";
...
const dusit_thani_lakeview_cairo = () => {
  const title = "Dusit Thani LakeView Cairo";
...
export default dynamic(() => Promise.resolve(dusit_thani_lakeview_cairo), {
  ssr: false,
});
