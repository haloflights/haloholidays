...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/doubletree_by_hilton_sharks_bay/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/doubletree_by_hilton_sharks_bay/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/doubletree_by_hilton_sharks_bay/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/doubletree_by_hilton_sharks_bay/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/doubletree_by_hilton_sharks_bay/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/doubletree_by_hilton_sharks_bay/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/doubletree_by_hilton_sharks_bay/GalleryCruiseSlider";
...
const doubletree_by_hilton_sharks_bay = () => {
  const title = "Doubletree By Hilton Sharks Bay";
...
export default dynamic(() => Promise.resolve(doubletree_by_hilton_sharks_bay), {
  ssr: false,
});
