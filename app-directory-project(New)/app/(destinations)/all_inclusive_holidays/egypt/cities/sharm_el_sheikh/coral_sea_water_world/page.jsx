...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/coral_sea_water_world/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/coral_sea_water_world/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/coral_sea_water_world/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/coral_sea_water_world/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/coral_sea_water_world/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/coral_sea_water_world/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/coral_sea_water_world/GalleryCruiseSlider";
...
const coral_sea_water_world = () => {
  const title = "Coral Sea Water World";
...
export default dynamic(() => Promise.resolve(coral_sea_water_world), {
  ssr: false,
});
