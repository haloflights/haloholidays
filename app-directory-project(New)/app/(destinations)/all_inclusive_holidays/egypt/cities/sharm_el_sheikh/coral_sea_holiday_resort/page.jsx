...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/coral_sea_holiday_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/coral_sea_holiday_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/coral_sea_holiday_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/coral_sea_holiday_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/coral_sea_holiday_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/coral_sea_holiday_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/coral_sea_holiday_resort/GalleryCruiseSlider";
...
const coral_sea_holiday_resort = () => {
  const title = "Coral Sea Holiday Resort";
...
export default dynamic(() => Promise.resolve(coral_sea_holiday_resort), {
  ssr: false,
});
