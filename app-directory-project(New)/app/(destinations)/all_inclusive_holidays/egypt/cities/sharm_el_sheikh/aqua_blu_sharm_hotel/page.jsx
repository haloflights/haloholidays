...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/aqua_blu_sharm_hotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/aqua_blu_sharm_hotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/aqua_blu_sharm_hotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/aqua_blu_sharm_hotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/aqua_blu_sharm_hotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/aqua_blu_sharm_hotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/aqua_blu_sharm_hotel/GalleryCruiseSlider";
...
const aqua_blu_sharm_hotel = () => {
  const title = "Aqua Blu Sharm Hotel";
...
export default dynamic(() => Promise.resolve(aqua_blu_sharm_hotel), {
  ssr: false,
});
