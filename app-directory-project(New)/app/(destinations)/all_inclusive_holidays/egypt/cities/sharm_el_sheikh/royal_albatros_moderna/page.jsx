...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/royal_albatros_moderna/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/royal_albatros_moderna/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/royal_albatros_moderna/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/royal_albatros_moderna/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/royal_albatros_moderna/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/royal_albatros_moderna/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/sharm_el_sheikh/royal_albatros_moderna/GalleryCruiseSlider";
...
const royal_albatros_moderna = () => {
  const title = "Royal Albatros Moderna";
...
export default dynamic(() => Promise.resolve(royal_albatros_moderna), {
  ssr: false,
});
