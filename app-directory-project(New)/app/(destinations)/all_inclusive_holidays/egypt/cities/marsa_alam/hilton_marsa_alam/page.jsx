...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/hilton_marsa_alam/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/hilton_marsa_alam/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/hilton_marsa_alam/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/hilton_marsa_alam/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/hilton_marsa_alam/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/hilton_marsa_alam/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/hilton_marsa_alam/GalleryCruiseSlider";
...
const hilton_marsa_alam = () => {
  const title = "Hilton Marsa Alam";
...
export default dynamic(() => Promise.resolve(hilton_marsa_alam), {
  ssr: false,
});
