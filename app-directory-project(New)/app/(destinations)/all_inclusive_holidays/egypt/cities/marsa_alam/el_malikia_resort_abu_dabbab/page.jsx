...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/el_malikia_resort_abu_dabbab/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/el_malikia_resort_abu_dabbab/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/el_malikia_resort_abu_dabbab/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/el_malikia_resort_abu_dabbab/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/el_malikia_resort_abu_dabbab/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/el_malikia_resort_abu_dabbab/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/el_malikia_resort_abu_dabbab/GalleryCruiseSlider";
...
const el_malikia_resort_abu_dabbab = () => {
  const title = "El Malikia Resort Abu Dabbab";
...
export default dynamic(() => Promise.resolve(el_malikia_resort_abu_dabbab), {
  ssr: false,
});
