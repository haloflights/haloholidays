...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/steigenberger_coraya_beach/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/steigenberger_coraya_beach/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/steigenberger_coraya_beach/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/steigenberger_coraya_beach/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/steigenberger_coraya_beach/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/steigenberger_coraya_beach/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/marsa_alam/steigenberger_coraya_beach/GalleryCruiseSlider";
...
const steigenberger_coraya_beach = () => {
  const title = "Steigenberger Coraya Beach";
...
export default dynamic(() => Promise.resolve(steigenberger_coraya_beach), {
  ssr: false,
});
