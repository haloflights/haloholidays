...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/jolie_ville_kings_island_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/jolie_ville_kings_island_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/jolie_ville_kings_island_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/jolie_ville_kings_island_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/jolie_ville_kings_island_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/jolie_ville_kings_island_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/jolie_ville_kings_island_resort/GalleryCruiseSlider";
...
const jolie_ville_kings_island_resort = () => {
  const title = "Jolie Ville Kings Island Resort";
...
export default dynamic(() => Promise.resolve(jolie_ville_kings_island_resort), {
  ssr: false,
});
