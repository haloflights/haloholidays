...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/hotel_hilton_luxor/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/hotel_hilton_luxor/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/hotel_hilton_luxor/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/hotel_hilton_luxor/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/hotel_hilton_luxor/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/hotel_hilton_luxor/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/hotel_hilton_luxor/GalleryCruiseSlider";
...
const hotel_hilton_luxor = () => {
  const title = "Hotel Hilton Luxor";
...
export default dynamic(() => Promise.resolve(hotel_hilton_luxor), {
  ssr: false,
});
