...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/iberotel_luxor/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/iberotel_luxor/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/iberotel_luxor/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/iberotel_luxor/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/iberotel_luxor/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/iberotel_luxor/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/luxor/iberotel_luxor/GalleryCruiseSlider";
...
const iberotel_luxor = () => {
  const title = "Iberotel Luxor";
...
export default dynamic(() => Promise.resolve(iberotel_luxor), {
  ssr: false,
});
