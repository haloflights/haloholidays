...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/premier_le_reve_hotel_and_spa/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/premier_le_reve_hotel_and_spa/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/premier_le_reve_hotel_and_spa/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/premier_le_reve_hotel_and_spa/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/premier_le_reve_hotel_and_spa/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/premier_le_reve_hotel_and_spa/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/premier_le_reve_hotel_and_spa/GalleryCruiseSlider";
...
const premier_le_reve_hotel_and_spa = () => {
  const title = "Premier Le Reve Hotel And Spa - Adults Only";
...
export default dynamic(() => Promise.resolve(premier_le_reve_hotel_and_spa), {
  ssr: false,
});
