...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/tropitel_sahl_hasheesh/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/tropitel_sahl_hasheesh/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/tropitel_sahl_hasheesh/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/tropitel_sahl_hasheesh/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/tropitel_sahl_hasheesh/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/tropitel_sahl_hasheesh/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/tropitel_sahl_hasheesh/GalleryCruiseSlider";
...
const tropitel_sahl_hasheesh = () => {
  const title = "Tropitel Sahl Hasheesh";
...
export default dynamic(() => Promise.resolve(tropitel_sahl_hasheesh), {
  ssr: false,
});
