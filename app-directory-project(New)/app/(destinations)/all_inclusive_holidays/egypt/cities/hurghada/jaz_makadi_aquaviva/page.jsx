...
import Overview from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/jaz_makadi_aquaviva/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/jaz_makadi_aquaviva/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/jaz_makadi_aquaviva/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/jaz_makadi_aquaviva/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/jaz_makadi_aquaviva/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/jaz_makadi_aquaviva/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/egypt/hurghada/jaz_makadi_aquaviva/GalleryCruiseSlider";
...
const jaz_makadi_aquaviva = () => {
  const title = "Jaz Makadi Aquaviva";
...
export default dynamic(() => Promise.resolve(jaz_makadi_aquaviva), {
  ssr: false,
});
