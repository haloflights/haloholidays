...
import Overview from "@/components/city-hotels/all_inclusive_holidays/bali/ubud/hanging_gardens_of_bali/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/bali/ubud/hanging_gardens_of_bali/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/bali/ubud/hanging_gardens_of_bali/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/bali/ubud/hanging_gardens_of_bali/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/bali/ubud/hanging_gardens_of_bali/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/bali/ubud/hanging_gardens_of_bali/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/bali/ubud/hanging_gardens_of_bali/GalleryCruiseSlider";
...
const hanging_gardens_of_bali = () => {
  const title = "Hanging Gardens of Bali";
...
export default dynamic(() => Promise.resolve(hanging_gardens_of_bali), {
  ssr: false,
});
