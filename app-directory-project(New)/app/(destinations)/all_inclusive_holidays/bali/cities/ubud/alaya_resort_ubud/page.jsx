...
import Overview from "@/components/city-hotels/all_inclusive_holidays/bali/ubud/alaya_resort_ubud/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/bali/ubud/alaya_resort_ubud/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/bali/ubud/alaya_resort_ubud/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/bali/ubud/alaya_resort_ubud/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/bali/ubud/alaya_resort_ubud/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/bali/ubud/alaya_resort_ubud/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/bali/ubud/alaya_resort_ubud/GalleryCruiseSlider";
...
const alaya_resort_ubud = () => {
  const title = "Alaya Resort Ubud";
...
export default dynamic(() => Promise.resolve(alaya_resort_ubud), {
  ssr: false,
});
