...
import Overview from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/courtyard_by_marriott_bali_seminyak_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/courtyard_by_marriott_bali_seminyak_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/courtyard_by_marriott_bali_seminyak_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/courtyard_by_marriott_bali_seminyak_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/courtyard_by_marriott_bali_seminyak_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/courtyard_by_marriott_bali_seminyak_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/courtyard_by_marriott_bali_seminyak_resort/GalleryCruiseSlider";
...
const courtyard_by_marriott_bali_seminyak_resort = () => {
  const title = "Courtyard by Marriott Bali Seminyak Resort";
...
export default dynamic(() => Promise.resolve(courtyard_by_marriott_bali_seminyak_resort), {
  ssr: false,
});
