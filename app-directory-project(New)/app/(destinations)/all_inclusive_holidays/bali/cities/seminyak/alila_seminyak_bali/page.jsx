...
import Overview from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/alila_seminyak_bali/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/alila_seminyak_bali/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/alila_seminyak_bali/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/alila_seminyak_bali/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/alila_seminyak_bali/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/alila_seminyak_bali/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/alila_seminyak_bali/GalleryCruiseSlider";
...
const alila_seminyak_bali = () => {
  const title = "Alila Seminyak Bali";
...
export default dynamic(() => Promise.resolve(alila_seminyak_bali), {
  ssr: false,
});
