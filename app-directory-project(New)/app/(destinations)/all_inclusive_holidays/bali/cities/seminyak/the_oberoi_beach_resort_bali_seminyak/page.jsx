...
import Overview from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/the_oberoi_beach_resort_bali_seminyak/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/the_oberoi_beach_resort_bali_seminyak/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/the_oberoi_beach_resort_bali_seminyak/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/the_oberoi_beach_resort_bali_seminyak/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/the_oberoi_beach_resort_bali_seminyak/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/the_oberoi_beach_resort_bali_seminyak/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/the_oberoi_beach_resort_bali_seminyak/GalleryCruiseSlider";
...
const the_oberoi_beach_resort_bali_seminyak = () => {
  const title = "The Oberoi Beach Resort Bali Seminyak";
...
export default dynamic(() => Promise.resolve(the_oberoi_beach_resort_bali_seminyak), {
  ssr: false,
});
