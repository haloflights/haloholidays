...
import Overview from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/double_six_luxury_hotel_seminyak/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/double_six_luxury_hotel_seminyak/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/double_six_luxury_hotel_seminyak/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/double_six_luxury_hotel_seminyak/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/double_six_luxury_hotel_seminyak/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/double_six_luxury_hotel_seminyak/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/bali/seminyak/double_six_luxury_hotel_seminyak/GalleryCruiseSlider";
...
const double_six_luxury_hotel_seminyak = () => {
  const title = "Double-Six Luxury Hotel Seminyak";
...
export default dynamic(() => Promise.resolve(double_six_luxury_hotel_seminyak), {
  ssr: false,
});
