...
import Overview from "@/components/city-hotels/all_inclusive_holidays/bali/nusa_dua/grand_hyatt_bali/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/bali/nusa_dua/grand_hyatt_bali/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/bali/nusa_dua/grand_hyatt_bali/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/bali/nusa_dua/grand_hyatt_bali/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/bali/nusa_dua/grand_hyatt_bali/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/bali/nusa_dua/grand_hyatt_bali/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/bali/nusa_dua/grand_hyatt_bali/GalleryCruiseSlider";
...
const grand_hyatt_bali = () => {
  const title = "Grand Hyatt Bali";
...
export default dynamic(() => Promise.resolve(grand_hyatt_bali), {
  ssr: false,
});
