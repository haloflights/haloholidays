...
import Overview from "@/components/city-hotels/all_inclusive_holidays/bali/nusa_dua/ayodya_resort_bali/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/bali/nusa_dua/ayodya_resort_bali/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/bali/nusa_dua/ayodya_resort_bali/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/bali/nusa_dua/ayodya_resort_bali/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/bali/nusa_dua/ayodya_resort_bali/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/bali/nusa_dua/ayodya_resort_bali/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/bali/nusa_dua/ayodya_resort_bali/GalleryCruiseSlider";
...
const ayodya_resort_bali = () => {
  const title = "Ayodya Resort Bali";
...
export default dynamic(() => Promise.resolve(ayodya_resort_bali), {
  ssr: false,
});
