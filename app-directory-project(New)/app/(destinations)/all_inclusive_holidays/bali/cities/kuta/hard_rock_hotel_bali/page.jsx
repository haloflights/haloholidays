...
import Overview from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/hard_rock_hotel_bali/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/hard_rock_hotel_bali/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/hard_rock_hotel_bali/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/hard_rock_hotel_bali/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/hard_rock_hotel_bali/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/hard_rock_hotel_bali/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/hard_rock_hotel_bali/GalleryCruiseSlider";
...
const hard_rock_hotel_bali = () => {
  const title = "Hard Rock Hotel Bali";
...
export default dynamic(() => Promise.resolve(hard_rock_hotel_bali), {
  ssr: false,
});
