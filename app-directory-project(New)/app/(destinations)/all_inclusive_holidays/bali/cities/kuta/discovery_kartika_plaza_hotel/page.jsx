...
import Overview from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/discovery_kartika_plaza_hotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/discovery_kartika_plaza_hotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/discovery_kartika_plaza_hotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/discovery_kartika_plaza_hotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/discovery_kartika_plaza_hotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/discovery_kartika_plaza_hotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/discovery_kartika_plaza_hotel/GalleryCruiseSlider";
...
const discovery_kartika_plaza_hotel = () => {
  const title = "Discovery Kartika Plaza Hotel";
...
export default dynamic(() => Promise.resolve(discovery_kartika_plaza_hotel), {
  ssr: false,
});
