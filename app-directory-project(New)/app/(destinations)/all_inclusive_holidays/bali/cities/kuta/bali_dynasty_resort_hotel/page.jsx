...
import Overview from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/bali_dynasty_resort_hotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/bali_dynasty_resort_hotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/bali_dynasty_resort_hotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/bali_dynasty_resort_hotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/bali_dynasty_resort_hotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/bali_dynasty_resort_hotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/bali/kuta/bali_dynasty_resort_hotel/GalleryCruiseSlider";
...
const bali_dynasty_resort_hotel = () => {
  const title = "Bali Dynasty Resort Hotel";
...
export default dynamic(() => Promise.resolve(bali_dynasty_resort_hotel), {
  ssr: false,
});
