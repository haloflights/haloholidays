...
import Overview from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/the_sakala_resort_bali/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/the_sakala_resort_bali/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/the_sakala_resort_bali/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/the_sakala_resort_bali/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/the_sakala_resort_bali/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/the_sakala_resort_bali/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/the_sakala_resort_bali/GalleryCruiseSlider";
...
const the_sakala_resort_bali = () => {
  const title = "The Sakala Resort Bali";
...
export default dynamic(() => Promise.resolve(the_sakala_resort_bali), {
  ssr: false,
});
