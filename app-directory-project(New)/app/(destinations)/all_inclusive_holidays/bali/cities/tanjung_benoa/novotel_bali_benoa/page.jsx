...
import Overview from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/novotel_bali_benoa/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/novotel_bali_benoa/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/novotel_bali_benoa/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/novotel_bali_benoa/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/novotel_bali_benoa/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/novotel_bali_benoa/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/novotel_bali_benoa/GalleryCruiseSlider";
...
const novotel_bali_benoa = () => {
  const title = "Novotel Bali Benoa";
...
export default dynamic(() => Promise.resolve(novotel_bali_benoa), {
  ssr: false,
});
