...
import Overview from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/hotel_nikko_bali_benoa_beach/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/hotel_nikko_bali_benoa_beach/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/hotel_nikko_bali_benoa_beach/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/hotel_nikko_bali_benoa_beach/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/hotel_nikko_bali_benoa_beach/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/hotel_nikko_bali_benoa_beach/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/hotel_nikko_bali_benoa_beach/GalleryCruiseSlider";
...
const hotel_nikko_bali_benoa_beach = () => {
  const title = "Hotel Nikko Bali Benoa Beach";
...
export default dynamic(() => Promise.resolve(hotel_nikko_bali_benoa_beach), {
  ssr: false,
});
