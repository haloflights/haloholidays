...
import Overview from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/grand_mirage_resort_and_thalasso_spa/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/grand_mirage_resort_and_thalasso_spa/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/grand_mirage_resort_and_thalasso_spa/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/grand_mirage_resort_and_thalasso_spa/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/grand_mirage_resort_and_thalasso_spa/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/grand_mirage_resort_and_thalasso_spa/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/grand_mirage_resort_and_thalasso_spa/GalleryCruiseSlider";
...
const grand_mirage_resort_and_thalasso_spa = () => {
  const title = "Grand Mirage Resort & Thalasso Spa";
...
export default dynamic(() => Promise.resolve(grand_mirage_resort_and_thalasso_spa), {
  ssr: false,
});
