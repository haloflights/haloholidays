...
import Overview from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/sol_by_melia_benoa_bali/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/sol_by_melia_benoa_bali/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/sol_by_melia_benoa_bali/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/sol_by_melia_benoa_bali/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/sol_by_melia_benoa_bali/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/sol_by_melia_benoa_bali/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/bali/tanjung_benoa/sol_by_melia_benoa_bali/GalleryCruiseSlider";
...
const sol_by_melia_benoa_bali = () => {
  const title = "Sol by Meliá Benoa Bali - All Inclusive";
...
export default dynamic(() => Promise.resolve(sol_by_melia_benoa_bali), {
  ssr: false,
});
