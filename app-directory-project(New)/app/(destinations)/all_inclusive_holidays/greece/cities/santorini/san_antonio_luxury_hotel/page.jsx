...
import Overview from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/san_antonio_luxury_hotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/san_antonio_luxury_hotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/san_antonio_luxury_hotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/san_antonio_luxury_hotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/san_antonio_luxury_hotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/san_antonio_luxury_hotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/san_antonio_luxury_hotel/GalleryCruiseSlider";
...
const san_antonio_luxury_hotel = () => {
  const title = "San Antonio Luxury Hotel";
...
export default dynamic(() => Promise.resolve(san_antonio_luxury_hotel), {
  ssr: false,
});
