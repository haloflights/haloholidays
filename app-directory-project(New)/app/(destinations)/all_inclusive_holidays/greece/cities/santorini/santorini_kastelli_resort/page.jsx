...
import Overview from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/santorini_kastelli_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/santorini_kastelli_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/santorini_kastelli_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/santorini_kastelli_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/santorini_kastelli_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/santorini_kastelli_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/santorini_kastelli_resort/GalleryCruiseSlider";
...
const santorini_kastelli_resort = () => {
  const title = "Santorini Kastelli Resort";
...
export default dynamic(() => Promise.resolve(santorini_kastelli_resort), {
  ssr: false,
});
