...
import Overview from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/alexandra_aparthotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/alexandra_aparthotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/alexandra_aparthotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/alexandra_aparthotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/alexandra_aparthotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/alexandra_aparthotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/alexandra_aparthotel/GalleryCruiseSlider";
...
const alexandra_aparthotel = () => {
  const title = "Alexandra Aparthotel";
...
export default dynamic(() => Promise.resolve(alexandra_aparthotel), {
  ssr: false,
});
