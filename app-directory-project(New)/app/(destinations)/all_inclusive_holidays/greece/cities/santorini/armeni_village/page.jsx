...
import Overview from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/armeni_village/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/armeni_village/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/armeni_village/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/armeni_village/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/armeni_village/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/armeni_village/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/greece/santorini/armeni_village/GalleryCruiseSlider";
...
const armeni_village = () => {
  const title = "Armeni Village";
...
export default dynamic(() => Promise.resolve(armeni_village), {
  ssr: false,
});
