...
import Overview from "@/components/city-hotels/all_inclusive_holidays/greece/rhodes/mitsis_selection_alila/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/greece/rhodes/mitsis_selection_alila/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/greece/rhodes/mitsis_selection_alila/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/greece/rhodes/mitsis_selection_alila/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/greece/rhodes/mitsis_selection_alila/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/greece/rhodes/mitsis_selection_alila/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/greece/rhodes/mitsis_selection_alila/GalleryCruiseSlider";
...
const mitsis_selection_alila = () => {
  const title = "Mitsis Selection Alila";
...
export default dynamic(() => Promise.resolve(mitsis_selection_alila), {
  ssr: false,
});
