...
import Overview from "@/components/city-hotels/all_inclusive_holidays/greece/crete/mitsis_selection_laguna/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/greece/crete/mitsis_selection_laguna/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/greece/crete/mitsis_selection_laguna/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/greece/crete/mitsis_selection_laguna/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/greece/crete/mitsis_selection_laguna/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/greece/crete/mitsis_selection_laguna/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/greece/crete/mitsis_selection_laguna/GalleryCruiseSlider";
...
const mitsis_selection_laguna = () => {
  const title = "Mitsis Selection Laguna";
...
export default dynamic(() => Promise.resolve(mitsis_selection_laguna), {
  ssr: false,
});
