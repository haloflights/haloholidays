...
import Overview from "@/components/city-hotels/all_inclusive_holidays/greece/crete/mitsis_royal_mare/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/greece/crete/mitsis_royal_mare/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/greece/crete/mitsis_royal_mare/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/greece/crete/mitsis_royal_mare/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/greece/crete/mitsis_royal_mare/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/greece/crete/mitsis_royal_mare/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/greece/crete/mitsis_royal_mare/GalleryCruiseSlider";
...
const mitsis_royal_mare = () => {
  const title = "Mitsis Royal Mare";
...
export default dynamic(() => Promise.resolve(mitsis_royal_mare), {
  ssr: false,
});
