...
import Overview from "@/components/city-hotels/all_inclusive_holidays/greece/crete/creta_maris_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/greece/crete/creta_maris_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/greece/crete/creta_maris_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/greece/crete/creta_maris_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/greece/crete/creta_maris_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/greece/crete/creta_maris_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/greece/crete/creta_maris_resort/GalleryCruiseSlider";
...
const creta_maris_resort = () => {
  const title = "Creta Maris Resort";
...
export default dynamic(() => Promise.resolve(creta_maris_resort), {
  ssr: false,
});
