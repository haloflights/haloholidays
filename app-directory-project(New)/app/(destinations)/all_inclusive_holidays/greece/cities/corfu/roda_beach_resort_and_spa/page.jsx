...
import Overview from "@/components/city-hotels/all_inclusive_holidays/greece/corfu/roda_beach_resort_and_spa/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/greece/corfu/roda_beach_resort_and_spa/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/greece/corfu/roda_beach_resort_and_spa/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/greece/corfu/roda_beach_resort_and_spa/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/greece/corfu/roda_beach_resort_and_spa/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/greece/corfu/roda_beach_resort_and_spa/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/greece/corfu/roda_beach_resort_and_spa/GalleryCruiseSlider";
...
const roda_beach_resort_and_spa = () => {
  const title = "Roda Beach Resort & Spa";
...
export default dynamic(() => Promise.resolve(roda_beach_resort_and_spa), {
  ssr: false,
});
