...
import Overview from "@/components/city-hotels/all_inclusive_holidays/greece/corfu/messonghi_beach/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/greece/corfu/messonghi_beach/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/greece/corfu/messonghi_beach/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/greece/corfu/messonghi_beach/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/greece/corfu/messonghi_beach/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/greece/corfu/messonghi_beach/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/greece/corfu/messonghi_beach/GalleryCruiseSlider";
...
const messonghi_beach = () => {
  const title = "Messonghi Beach";
...
export default dynamic(() => Promise.resolve(messonghi_beach), {
  ssr: false,
});
