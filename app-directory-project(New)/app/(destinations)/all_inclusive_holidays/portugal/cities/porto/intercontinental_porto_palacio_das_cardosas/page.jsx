...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/intercontinental_porto_palacio_das_cardosas/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/intercontinental_porto_palacio_das_cardosas/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/intercontinental_porto_palacio_das_cardosas/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/intercontinental_porto_palacio_das_cardosas/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/intercontinental_porto_palacio_das_cardosas/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/intercontinental_porto_palacio_das_cardosas/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/intercontinental_porto_palacio_das_cardosas/GalleryCruiseSlider";
...
const intercontinental_porto_palacio_das_cardosas = () => {
  const title = "InterContinental Porto Palacio das Cardosas";
...
export default dynamic(() => Promise.resolve(intercontinental_porto_palacio_das_cardosas), {
  ssr: false,
});
