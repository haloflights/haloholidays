...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/pestana_palacio_do_freixo/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/pestana_palacio_do_freixo/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/pestana_palacio_do_freixo/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/pestana_palacio_do_freixo/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/pestana_palacio_do_freixo/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/pestana_palacio_do_freixo/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/pestana_palacio_do_freixo/GalleryCruiseSlider";
...
const pestana_palacio_do_freixo = () => {
  const title = "Pestana Palacio do Freixo";
...
export default dynamic(() => Promise.resolve(pestana_palacio_do_freixo), {
  ssr: false,
});
