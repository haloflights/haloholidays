...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/pestana_vintage_porto_hotel_and_world_heritage_site/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/pestana_vintage_porto_hotel_and_world_heritage_site/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/pestana_vintage_porto_hotel_and_world_heritage_site/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/pestana_vintage_porto_hotel_and_world_heritage_site/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/pestana_vintage_porto_hotel_and_world_heritage_site/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/pestana_vintage_porto_hotel_and_world_heritage_site/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/pestana_vintage_porto_hotel_and_world_heritage_site/GalleryCruiseSlider";
...
const pestana_vintage_porto_hotel_and_world_heritage_site = () => {
  const title = "Pestana Vintage Porto-Hotel & World Heritage Site";
...
export default dynamic(() => Promise.resolve(pestana_vintage_porto_hotel_and_world_heritage_site), {
  ssr: false,
});
