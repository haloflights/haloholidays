...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/grande_hotel_do_porto/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/grande_hotel_do_porto/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/grande_hotel_do_porto/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/grande_hotel_do_porto/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/grande_hotel_do_porto/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/grande_hotel_do_porto/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/porto/grande_hotel_do_porto/GalleryCruiseSlider";
...
const grande_hotel_do_porto = () => {
  const title = "Grande Hotel do Porto";
...
export default dynamic(() => Promise.resolve(grande_hotel_do_porto), {
  ssr: false,
});
