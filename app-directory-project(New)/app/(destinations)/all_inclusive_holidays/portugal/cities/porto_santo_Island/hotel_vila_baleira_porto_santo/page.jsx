...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/hotel_vila_baleira_porto_santo/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/hotel_vila_baleira_porto_santo/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/hotel_vila_baleira_porto_santo/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/hotel_vila_baleira_porto_santo/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/hotel_vila_baleira_porto_santo/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/hotel_vila_baleira_porto_santo/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/hotel_vila_baleira_porto_santo/GalleryCruiseSlider";
...
const hotel_vila_baleira_porto_santo = () => {
  const title = "Hotel Vila Baleira Porto Santo";
...
export default dynamic(() => Promise.resolve(hotel_vila_baleira_porto_santo), {
  ssr: false,
});
