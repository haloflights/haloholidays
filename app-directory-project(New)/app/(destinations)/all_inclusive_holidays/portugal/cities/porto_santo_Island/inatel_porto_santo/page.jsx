...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/inatel_porto_santo/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/inatel_porto_santo/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/inatel_porto_santo/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/inatel_porto_santo/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/inatel_porto_santo/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/inatel_porto_santo/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/inatel_porto_santo/GalleryCruiseSlider";
...
const inatel_porto_santo = () => {
  const title = "Inatel Porto Santo";
...
export default dynamic(() => Promise.resolve(inatel_porto_santo), {
  ssr: false,
});
