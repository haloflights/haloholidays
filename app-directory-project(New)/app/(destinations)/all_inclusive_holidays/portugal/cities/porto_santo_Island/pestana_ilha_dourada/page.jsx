...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/pestana_ilha_dourada/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/pestana_ilha_dourada/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/pestana_ilha_dourada/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/pestana_ilha_dourada/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/pestana_ilha_dourada/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/pestana_ilha_dourada/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/porto_santo_Island/pestana_ilha_dourada/GalleryCruiseSlider";
...
const pestana_ilha_dourada = () => {
  const title = "Pestana Ilha Dourada";
...
export default dynamic(() => Promise.resolve(pestana_ilha_dourada), {
  ssr: false,
});
