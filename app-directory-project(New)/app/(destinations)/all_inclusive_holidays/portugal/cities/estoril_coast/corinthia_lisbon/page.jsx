...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/corinthia_lisbon/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/corinthia_lisbon/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/corinthia_lisbon/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/corinthia_lisbon/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/corinthia_lisbon/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/corinthia_lisbon/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/corinthia_lisbon/GalleryCruiseSlider";
...
const corinthia_lisbon = () => {
  const title = "Corinthia Lisbon";
...
export default dynamic(() => Promise.resolve(corinthia_lisbon), {
  ssr: false,
});
