...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/jupiter_lisboa_hotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/jupiter_lisboa_hotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/jupiter_lisboa_hotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/jupiter_lisboa_hotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/jupiter_lisboa_hotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/jupiter_lisboa_hotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/jupiter_lisboa_hotel/GalleryCruiseSlider";
...
const jupiter_lisboa_hotel = () => {
  const title = "Jupiter Lisboa Hotel";
...
export default dynamic(() => Promise.resolve(jupiter_lisboa_hotel), {
  ssr: false,
});
