...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/browns_central_hotel/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/browns_central_hotel/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/browns_central_hotel/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/browns_central_hotel/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/browns_central_hotel/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/browns_central_hotel/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/browns_central_hotel/GalleryCruiseSlider";
...
const browns_central_hotel = () => {
  const title = "Brown's Central Hotel";
...
export default dynamic(() => Promise.resolve(browns_central_hotel), {
  ssr: false,
});
