...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/h10_duque_de_loule/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/h10_duque_de_loule/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/h10_duque_de_loule/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/h10_duque_de_loule/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/h10_duque_de_loule/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/h10_duque_de_loule/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/estoril_coast/h10_duque_de_loule/GalleryCruiseSlider";
...
const h10_duque_de_loule = () => {
  const title = "H10 Duque de Loule";
...
export default dynamic(() => Promise.resolve(h10_duque_de_loule), {
  ssr: false,
});
