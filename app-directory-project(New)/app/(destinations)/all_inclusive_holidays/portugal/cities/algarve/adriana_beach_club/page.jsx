...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/adriana_beach_club/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/adriana_beach_club/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/adriana_beach_club/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/adriana_beach_club/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/adriana_beach_club/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/adriana_beach_club/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/adriana_beach_club/GalleryCruiseSlider";
...
const adriana_beach_club = () => {
  const title = "Adriana Beach Club";
...
export default dynamic(() => Promise.resolve(adriana_beach_club), {
  ssr: false,
});
