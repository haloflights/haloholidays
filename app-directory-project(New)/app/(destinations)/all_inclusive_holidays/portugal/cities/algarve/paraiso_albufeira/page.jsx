...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/paraiso_albufeira/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/paraiso_albufeira/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/paraiso_albufeira/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/paraiso_albufeira/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/paraiso_albufeira/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/paraiso_albufeira/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/paraiso_albufeira/GalleryCruiseSlider";
...
const paraiso_albufeira = () => {
  const title = "Paraiso Albufeira";
...
export default dynamic(() => Promise.resolve(paraiso_albufeira), {
  ssr: false,
});
