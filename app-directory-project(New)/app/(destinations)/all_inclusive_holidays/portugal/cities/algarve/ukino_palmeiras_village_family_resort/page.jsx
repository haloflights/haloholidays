...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/ukino_palmeiras_village_family_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/ukino_palmeiras_village_family_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/ukino_palmeiras_village_family_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/ukino_palmeiras_village_family_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/ukino_palmeiras_village_family_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/ukino_palmeiras_village_family_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/ukino_palmeiras_village_family_resort/GalleryCruiseSlider";
...
const ukino_palmeiras_village_family_resort = () => {
  const title = "UKINO Palmeiras Village - Family Resort";
...
export default dynamic(() => Promise.resolve(ukino_palmeiras_village_family_resort), {
  ssr: false,
});
