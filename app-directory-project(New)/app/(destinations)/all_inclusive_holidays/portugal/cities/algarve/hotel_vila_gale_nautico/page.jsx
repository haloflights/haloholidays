...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/hotel_vila_gale_nautico/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/hotel_vila_gale_nautico/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/hotel_vila_gale_nautico/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/hotel_vila_gale_nautico/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/hotel_vila_gale_nautico/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/hotel_vila_gale_nautico/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/algarve/hotel_vila_gale_nautico/GalleryCruiseSlider";
...
const hotel_vila_gale_nautico = () => {
  const title = "Hotel Vila Gale Nautico";
...
export default dynamic(() => Promise.resolve(hotel_vila_gale_nautico), {
  ssr: false,
});
