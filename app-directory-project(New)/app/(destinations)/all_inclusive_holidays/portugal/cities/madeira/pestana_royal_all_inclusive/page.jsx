...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/pestana_royal_all_inclusive/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/pestana_royal_all_inclusive/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/pestana_royal_all_inclusive/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/pestana_royal_all_inclusive/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/pestana_royal_all_inclusive/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/pestana_royal_all_inclusive/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/pestana_royal_all_inclusive/GalleryCruiseSlider";
...
const pestana_royal_all_inclusive = () => {
  const title = "Pestana Royal All Inclusive";
...
export default dynamic(() => Promise.resolve(pestana_royal_all_inclusive), {
  ssr: false,
});
