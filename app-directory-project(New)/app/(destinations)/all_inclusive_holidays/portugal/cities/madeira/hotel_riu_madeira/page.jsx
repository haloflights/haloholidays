...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/hotel_riu_madeira/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/hotel_riu_madeira/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/hotel_riu_madeira/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/hotel_riu_madeira/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/hotel_riu_madeira/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/hotel_riu_madeira/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/hotel_riu_madeira/GalleryCruiseSlider";
...
const hotel_riu_madeira = () => {
  const title = "Hotel Riu Madeira";
...
export default dynamic(() => Promise.resolve(hotel_riu_madeira), {
  ssr: false,
});
