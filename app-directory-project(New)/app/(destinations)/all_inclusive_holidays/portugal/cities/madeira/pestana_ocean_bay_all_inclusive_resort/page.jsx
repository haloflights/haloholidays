...
import Overview from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/pestana_ocean_bay_all_inclusive_resort/Overview";
import TopBreadCrumb from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/pestana_ocean_bay_all_inclusive_resort/TopBreadCrumb";
import SidebarRight from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/pestana_ocean_bay_all_inclusive_resort/SidebarRight";
import ReviewProgress from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/pestana_ocean_bay_all_inclusive_resort/guest-reviews/ReviewProgress";
import Facilities from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/pestana_ocean_bay_all_inclusive_resort/Facilities";
import DefaultFooter from "@/components/footer/default";
import MapPropertyFinder from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/pestana_ocean_bay_all_inclusive_resort/MapPropertyFinder";
import GalleryCruiseSlider from "@/components/city-hotels/all_inclusive_holidays/portugal/madeira/pestana_ocean_bay_all_inclusive_resort/GalleryCruiseSlider";
...
const pestana_ocean_bay_all_inclusive_resort = () => {
  const title = "Pestana Ocean Bay All Inclusive Resort";
...
export default dynamic(() => Promise.resolve(pestana_ocean_bay_all_inclusive_resort), {
  ssr: false,
});
