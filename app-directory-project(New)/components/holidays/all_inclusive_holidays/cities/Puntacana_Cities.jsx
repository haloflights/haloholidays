...
import { all_inclusive_punta_cana_destinations } from "@/data/cities";
import Link from "next/link";

const Puntacana_cities = () => {
  return (
    <div className="pt-40 overflow-hidden js-section-slider">
      ...
      >
        {all_inclusive_punta_cana_destinations.map((item) => (
...
export default Puntacana_cities;
