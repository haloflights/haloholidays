...
import { family_phuket_city_hotels } from "@/data/city_hotels";
import { Swiper, SwiperSlide } from "swiper/react";
import { Navigation, Pagination } from "swiper";
import Image from "next/image";
import Link from "next/link";

const Tri_tang_beach_HotelProperties = () => {
  return (
    <>
      {family_phuket_city_hotels.slice(5, 7).map((item) => (
...
export default Tri_tang_beach_HotelProperties;
