...
import { family_greece_city_hotels, greece_city_hotels } from "@/data/city_hotels";
import { Swiper, SwiperSlide } from "swiper/react";
import { Navigation, Pagination } from "swiper";
import Image from "next/image";
import Link from "next/link";

const Santorini_HotelProperties = () => {
  return (
    <>
      {family_greece_city_hotels.slice(10,15).map((item) => (
...
export default Santorini_HotelProperties;
