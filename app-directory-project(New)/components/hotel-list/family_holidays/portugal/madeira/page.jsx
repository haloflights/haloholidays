...
import { family_portugal_city_hotels, portugal_city_hotels } from "@/data/city_hotels";

const Madeira_HotelProperties = () => {
  return (
    <>
      {family_portugal_city_hotels.slice(5,10).map((item) => (
...
export default Madeira_HotelProperties;
