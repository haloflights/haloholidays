...
import { family_spain_city_hotels, spain_city_hotels } from "@/data/city_hotels";
import { Swiper, SwiperSlide } from "swiper/react";
import { Navigation, Pagination } from "swiper";
import Image from "next/image";
import Link from "next/link";

const Balearic_islands_HotelProperties = () => {
  return (
    <>
      {family_spain_city_hotels.slice(0, 5).map((item) => (
...
export default Balearic_islands_HotelProperties;
