...
import { punta_cana_city_hotels } from "@/data/city_hotels";

const Uvero_Alto_HotelProperties = () => {
  return (
    <>
      {punta_cana_city_hotels.slice(15,20).map((item) => (
...
export default Uvero_Alto_HotelProperties;
