...
import { greece_city_hotels, luxury_greece_city_hotels } from "@/data/city_hotels";
import { Swiper, SwiperSlide } from "swiper/react";
import { Navigation, Pagination } from "swiper";
import Image from "next/image";
import Link from "next/link";

const Rhodes_HotelProperties = () => {
  return (
    <>
      {luxury_greece_city_hotels.slice(20,25).map((item) => (
...
export default Rhodes_HotelProperties;
