...
import { honeymoon_portugal_city_hotels } from "@/data/city_hotels";

const Porto_Santo_Island_HotelProperties = () => {
  return (
    <>
      {honeymoon_portugal_city_hotels.slice(15,20).map((item) => (
...
export default Porto_Santo_Island_HotelProperties;
