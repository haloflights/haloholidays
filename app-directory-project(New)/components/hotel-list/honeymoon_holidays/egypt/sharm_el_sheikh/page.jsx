...
import { honeymoon_egypt_city_hotels } from "@/data/city_hotels";

const Sharm_el_sheikh_HotelProperties = () => {
  return (
    <>
      {honeymoon_egypt_city_hotels.slice(5,10).map((item) => (
...
export default Sharm_el_sheikh_HotelProperties;
