...
import { last_minute_cyprus_city_hotels } from "@/data/city_hotels";
import { Swiper, SwiperSlide } from "swiper/react";
import { Navigation, Pagination } from "swiper";
import Image from "next/image";
import Link from "next/link";

const Paphos_area_HotelProperties = () => {
  return (
    <>
      {last_minute_cyprus_city_hotels.slice(5, 10).map((item) => (
...
export default Paphos_area_HotelProperties;
