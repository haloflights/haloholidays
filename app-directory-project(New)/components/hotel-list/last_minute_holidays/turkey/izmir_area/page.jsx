...
import {last_minute_turkey_city_hotels } from "@/data/city_hotels";

const Izmir_area_HotelProperties = () => {
  return (
    <>
      {last_minute_turkey_city_hotels.slice(20,25).map((item) => (
...
export default Izmir_area_HotelProperties;
