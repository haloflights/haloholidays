...
import { last_minute_bali_city_hotels } from "@/data/city_hotels";

const Tanjung_benoa_HotelProperties = () => {
  return (
    <>
      {last_minute_bali_city_hotels.slice(10, 15).map((item) => (
...
export default Tanjung_benoa_HotelProperties;
