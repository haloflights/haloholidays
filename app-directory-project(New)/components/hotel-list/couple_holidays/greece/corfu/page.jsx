...
'use client'
import { couple_greece_city_hotels, greece_city_hotels } from "@/data/city_hotels";
...
const Corfu_HotelProperties = () => {
  return (
    <>
      {couple_greece_city_hotels.slice(5,10).map((item) => (
...
export default Corfu_HotelProperties;
